        ...
        <section class="py-10">
            ...
            <div class="bg-gray-900 text-white py-6">
                <div class="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">
                    <h1 class="text-2xl font-bold mb-2 lg:mb-0">Modules par formations</h1>
                    <nav class="text-sm">
                        <ol class="flex space-x-2">
                            <li><a href="/" class="hover:underline">Accueil</a></li>
                            <li class="text-gray-400">/ module par Formations</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <section id="services" class="services section py-16 bg-gray-50">
                <div class="container mx-auto text-center" data-aos="fade-up">
                    <h2 class="text-3xl font-semibold text-gray-800">MES MODULES PAR FORMATIONS</h2>
                    <!-- <p class="text-gray-600 mt-4">Des services d’audit et de conseils fiscaux pour les entreprises et particuliers</p> -->
                </div><!-- End Section Title -->
                
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        @foreach($formation as $chapitres)
                            <div class="product_data" data-aos="fade-up" data-aos-delay="100">
                                <div class="service-item bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all">
                                    <div class="image mb-4">
                                        <img src="{{ asset('assets/uploads/chapitre_images/'.$chapitres->image_url) }}" class="w-full h-48 object-cover rounded-lg" alt="">
                                    </div>
                                    <h3 class="text-xl font-semibold text-center text-gray-800 mb-4">{{ $chapitres->titre }}</h3>
                                    <p class="text-gray-600 mb-4">{!! $chapitres->description !!}</p>
                                    <div class="flex justify-between">
                                        <a href="{{url('quiz/'.$chapitres->id)}}" target="blank" class="btn btn-success py-2 px-4 bg-green-500 text-white rounded-lg hover:bg-green-600">Faire un quiz</a>
                                        <a href="{{asset('assets/uploads/chapitre_documents/'.$chapitres->document_url)}}" target="blank" class="btn btn-primary py-2 px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Télécharger le module</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
