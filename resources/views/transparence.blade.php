...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        ...
        <section class=" bg-[url('/images/blog-1.jpg')]  lg:bg-cover mt-16" w-800>
            <div class="bg-white">
                <p class="text-sm mx-5 text-black">
                    {{ __('NKCCG > Et vous, quelle équation voulez-vous résoudre ? > Stratégie : répondre aux enjeux écologiques et sociétaux') }}
                </p>
            </div>
            ...
            <div class="tc  w-full   ">
                ...
                <div class="  lg:ml-6  mt-72 lg:mr-6 lg:px-20 lg:w-2/3">
                    ...
                    <h1 class="text-xl font-serif text-left ml-9  text-white bg-gray-800 mr-32 px-4">
                        {{ __('Intégrer transparence et maîtrise des risques pour renforcer la confiance') }}
                    </h1>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3 mx-auto">
                    <div class="inline-block mt-5 ml-8">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des organisations en France ont connu au moins une crise au cours des 5 années') }}
                        </p>
                        <p class="text-sm my-5">
                            {{ __('Source : Etude NKCCG - Gestion de crise et résilience des SI') }}</p>
                    ...
                    <div class="inline-block mt-5 mx-4">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des organisations pensent que leur exposition aux risques s’intensifie') }}
                        </p>

                        <p class="text-sm my-5"> {{ __('Source : NKCCG 2020 - Global Risk Survey') }}</p>
                    </div>
                    ...
                    <div class="inline-block mt-5 mx-4">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des organisations prévoient d’augmenter leurs investissements afin d’accroître leur résilience') }}
                        </p>

                        <p class="text-sm my-5">1{{ __('Source : NKCCG Global Crisis Survey 202') }}</p>
                    </div>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            ...
            <div>
                ...
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                    {{ __('La pandémie de Covid-19, en créant des risques nouveaux en l’absence de mécanismes institutionnels stabilisateurs, a mis en évidence la vulnérabilité des entreprises dans de multiples dimensions. Il leur est désormais impératif d’être capable de s’adapter à un environnement plus risqué et plus complexe à appréhender. Les dispositifs de gestion des risques doivent opérer une double transformation. D’une part, ils deviennent plus stratégiques, holistiques et prospectifs pour mieux anticiper et permettre aux entreprises de se préparer. D’autre part, ils doivent améliorer la résilience et leur efficacité pour pouvoir réagir rapidement et surmonter les crises importantes. Enfin, dans un contexte incertain, communiquer avec transparence vis-à-vis de l’ensemble des parties prenantes est nécessaire.') }}
                </p>
        ...
        <section class="bg-gray-100 py-10">
            <h1 class=" text-4xl ml-10 text-gray-800">
                {{ __('Préparation à la CSRD : les résultats de la collaboration entre Michelin et NKCCG') }}
            </h1>
            <div class=" grid gap-6 mb-6 md:grid-cols-2 mx-auto">
                <div class="mt-10">
                    <h3 class="font-bold text-2xl text-gray-800 ml-10 mb-1 ">{{ __('Video') }}</h3>
                    <p class="ml-10 mb-5">{{ __('Veuillez accepter tous les cookies pour visionner cette vidéo.') }}
                    </p>

                    <div class="flex justify-center items-center">
                        <button type="button"
                            class=" py-2.5 px-5 me-2 mb-2  text-lg font-bold text-gray-900 text-center focus:outline-none bg-transparent border border-gray-400 hover:bg-gray-500 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200 ">
                            {{ __('Paramètres des cookies') }}</button>
                    </div>
                </div>
                <div>
                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide mx-8 text-xl mb-5">
                        {{ __('Dans un contexte d’évolution réglementaire rapide et d’exigences croissantes en matière de reporting de durabilité, le Groupe Michelin a fait confiance à NKCCG pour l’accompagner dans la sensibilisation de plus de 120 collaborateurs aux enjeux de la CSRD (Corporate Sustainability Reporting Directive). Face à un calendrier d’application strict et à des textes réglementaires en constante évolution, NKCCG a été choisi pour mobiliser les contributeurs internes de Michelin, mesurer les écarts et apporter son expertise pour identifier les pistes de chantier à mener. Cette collaboration a permis de catalyser l’intelligence collective, préparant Michelin à un avenir durable et à la conformité réglementaire.') }}
                    </p>
        ...
        <section class="">
            ...
            <div class="py-10 lg:ml-10 mx-6">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-5 mb-5 ">
                    {{ __('Construire la confiance grâce à plus de transparence') }}
                </h2>
                ...
                <div class=" mb-6 lg:flex lg:mx-12 ">
                    <div class="lg:mr-6 mt-5 lg:w-1/2 ">
                        ...
                        <div class=" mt-1">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-5 lg:mx-7">
                                {{ __('Communiquer avec transparence') }}
                            </h3>

                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8  text-xl ">
                                {{ __('Le besoin de confiance est plus fort que jamais. Les entreprises doivent alors réussir à communiquer de manière transparente sur leurs activités, leurs risques et leurs engagements, d’autant plus que la pression réglementaire sur cette communication est de plus en plus forte. Avoir un dispositif de reporting robuste devient incontournable pour s’assurer de la fiabilité de l’information communiquée aux différentes parties prenantes.') }}
                            </p>
        ...
        <section class=" py-10">
            ...
            <div class=" bg-gray-100  py-10">
                ...
                <h2 class="lg:text-4xl text-xl text-gray-800 lg:mx-8 py-1 lg:px-10 mb-5 mx-6 ">
                    {{ __('Assurer sa transformation et sa résilience grâce à la gestion des risques') }}
                </h2>
                ...
                <div class=" lg:mx-12 mt-5 lg:flex ">
                    <div class="lg:mr-6 mt-5 lg:w-1/3 mx-6 lg:mx-0">
                        <button
                            ...
                            <span class=" text-xl text-white">
                                {{ __('Simuler les risques pour mieux anticiper') }}</span>

                        </button>
                        <p class="text-center text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Simuler les risques pour mieux anticiper') }}
                        </p>
                    ...
                    <div class=" lg:w-2/3">
                        <div class=" mt-5">
                            <h3 class="lg:text-4xl text-2xl font-bold text-gray-800 mb-5 mx-6 lg:mx-7">
                                {{ __('Simuler les risques pour mieux anticiper') }}</h3>
                            <p class="text-gray-800 leading-relaxed  tracking-wide mx-8 mb-4">
                                {{ __('Aujourd’hui, l’enjeu en matière de gestion des risques est de développer une analyse prospective des risques afin de mieux anticiper les prochaines crises et évolutions majeures. Les organisations peuvent faire évoluer leur approche des risques avec l’analyse de scénarios et une meilleure exploitation des données grâce à la technologie.') }}
                            </p>
                ...
                <div class="w-full ">
                    ...
                    <div class="lg:flex mx-6 lg:mx-12  justify-between ">
                        ...
                        <div class="">
                            ...
                            <p class=" text-sm  lg:text-xl   mt-4 text-gray-600">
                                {{ __('L’humain au centre de l’échiquier') }}
                            </p>
