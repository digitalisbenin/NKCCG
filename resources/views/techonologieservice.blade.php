...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        <section
            class=" bg-[url('/images/contexte-programmation-personne-travaillant-codes-ordinateur.jpg')]  lg:bg-cover mt-16 ">
            <!-- Bg Shape -->
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    ...
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9 mt-4 text-white">
                        ...
                        {{ __('Les acteurs du secteur de la technologie voient leurs opportunités de développement s’accroître et se diversifier. Les nouvelles technologies telles que le cloud (SaaS), l’IA, la blockchain ou l’IoT ouvrent de nouvelles perspectives de croissance et doivent être durables.') }}
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('part de marché des SMACS (Social-Mobile-Analytics-Cloud) dans les logiciels et services') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">

                        {{ __('Source : Syntec Numérique') }}
                    </p>
                </div>
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('CA du marché des services informatiques et du conseil en technologies en France') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('de croissance pour les 100 premiers acteurs français du Digital') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
        ...
        <section class="bg-gray-200 ">
            ...
            <div class="lg:mx-24 lg:flex mx-6 lg:mx-0">
                <div class="lg:w-1/2 lg:mr-4">
                    <p class="text-black text-xl  ">

                        {{ __('Le domaine des technologies est en pleine mutation :') }}
                    ...
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            ...
                            {{ __('L’ère du Software as a Service') }}
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('Des innovations au service de la transformation des entreprises') }}
                ...
                <div class="lg:w-1/2 mt-4 lg:mt-0">
                    <img src="images/damil-gettyimages-1010851910-67000.avif" class="">
                </div>
            </div>
            <div class="h-6"></div>
        ...
        <section class=" ">
            ...
            <div class="mx-6 lg:mx-24">
                ...
                <h1 class="lg:text-4xl text-2xl font-serif text-left  text-black">
                    ...
                    {{ __(' Technologie : la disruption permanente') }}
                </h1>
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    ...
                    {{ __('Les acteurs traditionnels du marché (éditeurs de logiciels, entreprises du hardware, fournisseur de services Internet, entreprises de services du numérique) s’engagent dans une phase de profonde transformation. Les logiciels, auparavant vendus comme des produits, deviennent des services (SaaS) dont les fonctionnalités sont dématérialisées dans le cloud.') }}
                </p>
                <p class="text-black  mt-6 lg:w-2/4 text-lg">

                    {{ __('Dans le même temps, les logiciels, combinés aux technologies numériques, permettent le développement de nouveaux services, toujours plus spécifiques et intégrés. Ces nouveaux acteurs émergent notamment sous la forme de plateformes (Uber, BlaBlaCar).') }}
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">

                    {{ __('Des acteurs novateurs') }}

                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">

                    {{ __('Vecteur clé de la transformation des entreprises, l’innovation technologique engage tous les acteurs à adapter leur modèle et leur culture. Gestion, exploitation, sécurisation matérielle et juridique des données des clients, création de nouveaux métiers et services, définition de stratégies de pricing adaptées sont les clés d’une transformation réussie. Les acteurs traditionnels de l’industrie technologique sont concernés et privilégient les acquisitions afin d’accélérer leur transformation digitale.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">

                    {{ __('Les usages des nouvelles technologies sont de plus en plus concrets et rentables pour la vie économique, assurant des retours sur investissements rapides aux grands projets de R&D. Le cadre français favorise ces investissements en R&D, notamment grâce au Crédit d’Impôt Recherche (CIR).') }}
                </p>
        ...
        <section class="bg-gray-200 ">
            ...
            <div class="lg:flex lg:mx-24 mx-6">
                ...
                <div class="lg:w-1/2 lg:ml-9 mt-24">
                    <h1 class="text-2xl font-bold text-left text-black">

                        {{ __('Un engagement commun au service de la communauté TMT') }}
                    </h1>
                    <p class="text-black text-xl mt-4  ">

                        {{ __('NKCCG est un membre historique de l’IDATE. A travers ce partenariat, NKCCG confirme sonengagement auprès des acteurs du secteur des TMT. Notamment en contribuant à la réflexion autour des enjeux de transformation du secteur grâce à la participation à la rédaction d’études, comme celle sur la Souveraineté Numérique pour le Digiworld Summit, et l’organisation d’événements à destination des membres du Club et des acteurs du secteur.') }}
                    </p>
                </div>
            ...
            <div class="lg:flex lg:mx-24 mx-6">
                <div class="lg:w-1/2 ">
                    <h1 class="text-4xl font-serif text-left text-black">
                        ...
                        {{ __('A propos de l’IDATE DigiWorld') }}
                    </h1>
                    <p class="text-black text-xl mt-4  ">

                        {{ __('L’IDATE DigiWorld est un Think Tank international, proposant une plateforme ouverte de débats et de partage d’expériences, pour comprendre le monde numérique d’aujourd’hui et préparer les décisions qui forgeront celui de demain.') }}
                    </p>
            ...
            <div class=" lg:h-44 lg:mx-24 mx-6 ">
                <div class="">
                    ...
                    <h1 class="text-2xl font-bold text-left text-white mt-2">
                        ...
                        {{ __('Le numérique au service de la durabilité') }}
                    </h1>
                    <a href="/#" class="flex gi lg:mt-4 w-52    text-black bg-white hover:bg-blue-700 block">
                        <span class="ml-4"> {{ __('En savoir plus') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class="bg-red-600">
            <!-- Bg Shape -->
            <div class="flex mx-6 lg:h-44 lg:mx-64 ">
                <img src="images/go-there-white.webp" class="h-24 mt-6">

                <div class="ml-6">

                    <p class="text-white lg:ml-4 mt-6 ">
                        {{ __('Matérialiser la 5G') }}
                    </p>
                    <a href="/contact" class="flex  gi lg:mt-4 lg:ml-4  text-white lg:text-3xl  text-xl block">
                        <span class="">
                            {{ __('Comment les entreprises peuvent tirer partie de la 5G ?') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
