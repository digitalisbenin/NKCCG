...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        <section class=" bg-[url('/images/blog-recent-4.jpg')]  lg:bg-cover mt-16 ">
            <!-- Bg Shape -->
            <div class="tc  w-full   ">
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des acteurs financiers envisagent de former leurs équipes aux nouvelles compétences du marché') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des acteurs financiers investissent dans une technologie pour lutter contre la cybercriminalité') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('de paiements sans contact par seconde en France') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <p class="text-black text-xl  ">
                        ...
                        {{ __('Nouvelles technologies, revenus sous pression, concurrence sur les marchés, les acteurs bancaires renouvellent leurs processus et leur travail.') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            ...
                            {{ __('Une avalanche réglementaire') }}
                        </li>
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('Une rentabilité et solidité du secteur') }}
                        </li>
                    </ul>

                </div>
                <div class="lg:w-1/2 mx-6 mt-4 lg:mt-0">
                    <img src="images/fr-555x312-istock-520884088.webp"
        ...
        <section class=" ">
            ...
            <div class=" lg:mx-24 mx-6">
                ...
                <h1 class="lg:text-4xl text-2xl font-serif text-left lg:w-2/4 text-black">
                    ...
                    {{ __('Banques et marchés de capitaux : nouvelles approches') }}
                </h1>
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    ...
                    {{ __('Avec l’émergence de nouvelles technologies et de nouveaux acteurs, le secteur mène une importante transformation digitale : les acteurs bancaires repensent la relation et l’expérience client et développent de nouveaux usages et solutions.') }}
                </p>
            ...
            <div class="flex   lg:h-44 lg:mx-64 mx-6 ">
                ...
                <div class="ml-6">
                    ...
                    <a href="/contact" class="flex  gi lg:mt-4 lg:ml-4  text-white lg:text-3xl text-lg  block">
                        <span class="">
                            {{ __('Découvrez notre offre Actuariat, risques et finance quantitative') }} <br>
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="  shadow-solid-13  ">
                ...
                <div class="w-full ">
                    ...
                    <div class="lg:flex lg:mx-24 mx-6 justify-between ">
                        <div class=" ">
                            <img src="images/dcqde1565.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                        ...
                        <div class=" ">
                            <img src="images/jdncshbdc.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                        ...
                        <div class=" ">
                            <img src="images/vcskjcbjhd.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                15/02/22
                            </p>
                        ...
                        <div class="">
                            <div class="flex ">
                                <img src="images/ok1265.webp" alt="marketing-digital-service-création-de-site-web"
                                    class=" h-44 w-80 ">
                            </div>
