...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        ...
        <section>
            ...
            <div class=" min-h-screen  lg:flex  lg:px-12 py-8  mt-20 " style="background-color:#e9e9e9 ;">
                <div class="">
                    <a href="/expertise"
                        class="lg:text-4xl lg:mt-9 text-sm text-blue-500 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('expertise') ? 'text-blue-700' : '' }}">EXPERTISES</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl uppercase  text-sm  lg:mt-4 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Études  ') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Études de marché ') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Etudes de faisabilité de projets d’investissement et de développement') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Etudes d’avant-projet (sommaire et détaillé)') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Etudes économiques et financières') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Etudes des chaînes de valeur agricole et industrielle') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Etudes de référence de projets de développement et d’investissement') }}
                    </a>
                    <p></p>

                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Elaboration de manuel de procédures administrative, comptable, financière et technique') }}
                    </a>
                    <p></p>

                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Études sectorielles et de développement.') }}
                    </a>

                    <p></p>

                    <a href="#"
                        class="lg:text-xl uppercase  text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Diagnostic et évaluation') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Diagnostic et analyse stratégiques') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Evaluation des immobilisations et du patrimoine') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Evaluation ex-ante et à mi-parcours de programmes et projets de développement') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Evaluation finale et d’impact de programmes et projets de développement') }}
                    </a>
                    ...
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Formation (finances publiques, audit, ressources humaines, stratégies, ) ') }}
                        <br>gestion des projets, planification stratégique, marketing, comptabilité d’entreprise<br> et
                    ...
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Programmes de formation adaptés') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Ateliers et sessions de renforcement de capacités') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl  uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Finances publiques et gestion   ') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Finances publiques') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Conseil à la fonction finance et gestion des risques') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Conseil financier ou TS (Transaction Services)') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Expertises spécialisées   ') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Agriculture, élevage et pêche') }}
                    </a>
                    ...
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Ingénierie en énergie électrique et solaire)') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Ingénierie industrielle et en technologie alimentaire)') }}
                    </a>
                    ...
                    <p></p>
                    <a href="#"
                        class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Développement durable et responsabilité sociale  ') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Développement durable') }}
                    ...
                    <a href="#"
                        class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Représentation et partenariat  ') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Représentation de groupes internationaux') }}
                ...
                <div class="lg:ml-6 lg:mt-20">
                    ...
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Elaboration de plans stratégiques, de plans  ') }}<br>opérationnels et de business<br> plan
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Elaboration de cadre organique') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Elaboration de politique nationale et régionale') }}<br> nationale et régionale</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('organisations') ? 'text-blue-700' : '' }}">
                        {{ __('Elaboration de stratégies sectorielles, nationales et régionales') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseil en stratégie') }}
                    ...
                    <a href="#"
                        class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Conception et mise en place de systèmes ') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conception et mise en place de modèle économique') }}<br>économique</a>
                    <p></p>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Mise en place de système de contrôle interne') }}</a>
                    <p></p>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Mise en place de comptabilité de gestion ou ') }}<br>de coût</a>
                    <p></p>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Mise en place de dispositif de gestion et de ') }}<br>maîtrise des risques</a>
                    <p></p>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Elaboration de cartographie des risques') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl uppercase  text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Services  ') }}
                    ...
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Services de conseil en stratégie') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Services de conseil opérationnel et ') }}<br>organisationnel</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conduite de changement organisationnel') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Management et organisation ') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                    ...
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Management et optimisation des processus') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600  hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils stratégiques et opérationnels ') }}</a>
                    <p></p>
                    <a href="#"
                    class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                    {{ __('Conseils en stratégie et développement') }}
                </a>
                <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils juridique et fiscal') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils en production animale') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils agricole et en politique') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils en digital & data') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils en opérations') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils en politique et communication') }}</a>
                    <p></p>
                    <a href="#"
                    class="lg:text-xl uppercase text-sm  lg:mt-9 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                    {{ __('Technologies et ingénierie ') }}</a>
                <p></p>
                <a href="#"
                    class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                    {{ __('Big data et ingénierie de données') }}
                </a>

                <p></p>
                <a href="#"
                    class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                    {{ __('Ingénierie en systèmes d’information') }}
                </a>

                <p></p>
                <a href="#"
                    class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                    {{ __('Ingénierie informatique') }}
                </a>
                ...
                {{-- <div class="lg:ml-12 lg:mt-20">
                    <a href="#"
                        class="lg:text-2xl lg:mt-6 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}"></a>
                        <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseil en opérations') }}
                    </a>
                    ...
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-6 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent  {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseils en Politique et Communication') }}
                    </a>

                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Conseil en digital & data') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('#') ? 'text-blue-700' : '' }}">
                    ...
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Représentation de groupes internationaux') }}
                    </a>
                ...
                <div class="lg:ml-12 lg:mt-20">
                    <a href="#"
                        class="lg:text-2xl lg:mt-6 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('#') ? 'text-blue-700' : '' }}"></a>
                        <a href="#"
                        class="lg:text-xl text-sm  lg:mt-4 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Transformation digitale') }}
                    </a>
