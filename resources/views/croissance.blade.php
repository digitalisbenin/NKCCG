...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        ...
        <section class=" bg-[url('/images/blog-4.jpg')]  lg:bg-cover mt-16" w-800>
            <div class="bg-white">
                <p class="text-sm mx-5 text-black">
                    {{ __('NKCCG > Et vous, quelle équation voulez-vous résoudre ? > Les entreprises ETI') }}
                </p>
            </div>
            ...
            <div class="tc  w-full   ">
                ...
                <div class="  lg:ml-6 mt-24 lg:mt-72 lg:mr-6 lg:px-20 lg:w-2/3">
                    <h1
                        ...
                        {{ __('Entreprises de taille intermédiaire (ETI)') }}

                    </h1>
                    <h1 class="text-xl font-serif text-left ml-9  text-white bg-gray-800 mr-32 px-4 inline-block">
                        {{ __('Des équipes et outils dédiés NKCCG au service de votre développement') }}
                    </h1>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-8 mx-6">
                <div>
                    ...
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5 ">
                        {{ __('Motrices économiques, actrices de l’intérêt général et source de cohésion sociale dans nos territoires, les entreprises de taille intermédiaire (ETI) représentent un poids considérable dans l’économie française. Elles génèrent 25 % de l’emploi, 34 % des exportations françaises et 75 % des sites de production sont situés dans les villes moyennes ou en zone rurale.') }}
                    </p>
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5 ">
                        {{ __('Les entreprises ETI conquérantes doivent investir pour poursuivre leur croissance et leur transformation.') }}
                    </p>
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                        {{ __('Impact sociétal et environnemental, digitalisation, attractivité des talents, transmission et compétitivité font partie de vos grands défis ? Pour répondre à vos enjeux, NKCCG a constitué une équipe de spécialistes et des offres sur-mesure.') }}
                    </p>
        ...
        <section class=" py-10">
            <h1 class=" leading-relaxed lg:text-4xl text-2xl lg:ml-10 mx-6 lg:mx-0 mb-5 text-gray-800">
                {{ __('Un accompagnement quelque soit votre') }}</h1>
            <h1 class=" leading-relaxed lg:text-4xl text-2xl lg:ml-10 mx-6 lg:mx-0 mb-5 text-gray-800">
                {{ __('structure capitaliste') }}</h1>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-3 lg:px-8">
                <div class="lg:px-5 mx-6 lg:mx-0">
                    <div class="flex items mb-4">
                        ...
                        <div>
                            <h3 class="font-bold lg:text-3xl text-xl text-gray-800 ml-5 mb-10 ">{{ __('ETI côtés') }}
                            </h3>
                    ...
                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('Renforcement de la gouvernance, formalisation accrue de l’évaluation des risques et de l’environnement de contrôle, production d’informations financières et extra financières complémentaires, raccourcissement des délais de clôture, et sur de nombreux autres enjeux, notre équipe vous apporte son expertise') }}
                    </p>
                ...
                <div class="lg:px-5 mx-6 lg:mx-0">
                    <div class="flex items mb-4">
                        ...
                        <div>
                            <h3 class="font-bold g:text-3xl text-xl text-gray-800 ml-5 mb-10 ">
                                {{ __('ETI familiales') }}</h3>

                        </div>
                    </div>

                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('NKCCG accompagne les dirigeants des entreprises familiales sur les sujets de transmission et succession, gouvernance, attractivité, fiscalité, risques, développement international, raisons d’être, etc. Pour ce faire, NKCCG a développé l’Owner’s Agenda. Une approche dédiée aux enjeux de l’entreprise et des actionnaires, adaptée aux valeurs et à la cultures des groupes familiaux.') }}
                    </p>
                ...
                <div class="lg:px-5 mx-6 lg:mx-0">
                    ...
                    <div class="flex items mb-4">
                        ...
                        <div>
                            <h3 class="font-bold g:text-3xl text-xl text-gray-800 ml-5 mb-10 ">
                                {{ __('ETI Private Equity') }}</h3>

                        </div>
                    </div>

                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('Sur de nombreuses problématiques liées à la création de valeur (croissance externe, internationalisation, digitalisation, transformation, RSE, conformité, financement, fiscalité, etc.), NKCCG aide les ETI de l’écosystème Private Equity. Sur l’ensemble des sujets transactionnels à l’occasion de la sortie de leur actionnaire financier, NKCCG accompagne également les sociétés de portefeuille.') }}
                    </p>
        ...
        <section class=" lg:py-10">
            ...
            <div class=" bg-gray-100  lg:py-10">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-8  mx-6 py-1 lg:px-10 mb-5   ">
                    {{ __('Accompagner les ETI sur l’ensemble de ses') }}
                </h2>
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-8  mx-6 py-1 lg:px-10 mb-5   ">
                    {{ __('problématiques stratégiques et opérationnelles') }}
                </h2>
                ...
                <div class=" lg:mx-12 mx-6 lg:mt-5 lg:flex ">
                    <div class="lg:mr-6 mt-5 lg:w-1/3 ">
                        <button
                            ...
                            <span
                                class=" text-xl text-white">{{ __('Concevoir des business models à l’épreuve des disruptions') }}</span>
                        ...
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Créer plus de valeur avec des stratégies de croissance externe ou de cession') }}
                        </p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Enrichir sa stratégie pour répondre aux enjeux écologiques et sociétaux') }}</p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Faire de la technologie un catalyseur de transformation et de compétitivité') }}
                        </p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Faire de la technologie un catalyseur de transformation et de compétitivité') }}
                        </p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Concilier performance et responsabilité sociale de l’entreprise') }}</p>
                    ...
                    <div class=" lg:w-2/3">
                        <div class=" mt-5">
                            <h3 class="lg:text-4xl text-2xl font-bold text-gray-800 mb-5 lg:mx-7">
                                {{ __('Concevoir des business models à l’épreuve des disruptions') }}
                            </h3>
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-8">
                                ">{{ __('De l’adaptation de votre structure de coûts au design de l’expérience idéale pour vos utilisateurs, l’équipe ETI vous accompagne sur le diagnostic et la définition de la feuille de route de votre Direction Financière, l’accélération et la mise en qualité de votre processus de clôture, le pilotage de vos performances, la sélection de votre futur ERP ainsi que sur des diagnostics Supply Chain / Opérations. Aussi, l’équipe ETI vous guidera sur tous les enjeux que vous rencontrez liés à l’optimisation de la performance de vos achats.') }}
                            </p>
                            ...
                            <a href="/#"
                                ...
                                <span
                                    class="ml-9 font-bold mr-6">{{ __('Transformation des business models') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class=" lg:py-10 mt-4 lg:mt-0">
            <h1 class=" lg:text-4xl text-2xl mx-6 lg:mx-0 lg:ml-10 text-gray-800">
                {{ __('ETI : comment vous aider à créer de la') }}</h1>
            <h1 class=" lg:text-4xl text-2xl mx-6 lg:mx-0 lg:ml-10 text-gray-800">
                {{ __('confiance et mener des transformations') }}</h1>
            <h1 class=" lg:text-4xl text-2xl mx-6 lg:mx-0 lg:ml-10 text-gray-800">
                {{ __('complexes pour des résultats durables ?') }}</h1>
        </section>
            ...
            <div class="flex   lg:h-44 lg:mx-64 mx-6">
                ...
                <div class="ml-6">
                    ...
                    <a href="/contact" class="flex  gi lg:mt-1 lg:ml-4  text-white lg:text-3xl text-lg inline-block">
                        <span class="">{{ __('Startups et Innovation') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-4 px-8 mb-5">
                        <div class=" ">
                            ...
                            <p class=" text-sm  lg:text-xl   mt-4 text-gray-600">
                                {{ __('Prospérer à l’ère de la réinvention') }}
                            </p>
                        ...
                        <div class=" ">
                            ...
                            <p class=" text-sm  lg:text-xl   mt-4 text-gray-600">
                                ...
                                {{ __('Entreprises familiales : engagées pour un futur durable') }}
                            </p>
