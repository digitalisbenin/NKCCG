            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left ml-9 mt-12 text-white ">
                        {{ __('Médias et loisirs') }}
                    </h1>
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9 mt-4 text-white">
                        {{ __('Pour les acteurs du secteur des médias et loisirs, l’expérience client est une priorité. C’est un axe majeur de différenciation porté par les technologies numériques, les contenus et l’exploitation des données.') }}
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24 mx-6">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('d’évolution annuelle du marché de la publicité digitale en France, soit près de 4,9 Mds €') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('de croissance prévue pour les activités de réalité virtuelle (VR) entre 2017 et 2022') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('de CA mondial prévu pour l’industrie des médias et loisirs entre 2017 et 2022') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
            ...
            <div class="lg:mx-24 lg:flex mx-6">
                <div class="lg:w-1/2 lg:mr-4">
                    <p class="text-black text-xl  ">
                        {{ __('Nouveaux modes de consommation, expérience client, innovation :') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('Les business modèles évoluent, les normes aussi') }}
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('La France s’inscrit dans la tendance') }}
                        </li>
                    </ul>
                </div>
        ...
        <section class=" ">
            ...
            <div class=" lg:mx-24 mx-6">
                ...
                <h1 class="text-4xl font-serif text-left  text-black">
                    {{ __('Médias et loisirs : une révolution en cours') }}
                </h1>
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    {{ __('La création de valeur ne s’appuie plus seulement sur la recherche de la meilleure combinaison entre contenus et stratégies de distribution. Pour se démarquer, les acteurs du secteur des médias et du divertissement se doivent de proposer une expérience client singulière ainsi valorisable.De nouveaux modes de consommation ont fait leur apparition provoquant, notamment, une saturation de l’offre et une perte de vitesse des marques traditionnelles.') }}
                </p>
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    {{ __('La télévision, par exemple, est consommée de manière asynchrone grâce au replay et sur un large éventail de supports physiques. Pour la musique, qui se consomme désormais majoritairement en ligne, le streaming s’impose et fait évoluer les business models. Aujourd’hui par exemple, les labels font surtout du profit avec les droits d’interprétation, qui constitue désormais la partie principale de leurs revenus.Le numérique est à la fois source de changements et d’opportunités : l’innovation technologique (4D, AR, VR,…) promet une expérience toujours plus immersive, susceptible de fidéliser l’utilisateur et de fédérer des communautés.') }}
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    {{ __('Des contenus ciblés pour les consommateurs') }}

                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Le développement des accès internet, de la vidéo sur internet, de la publicité en ligne et des jeux vidéo sont des moteurs de croissance.Les initiatives pour rassembler les consommateurs dans des communautés solides se multiplient, notamment dans le secteur des médias. Les transformer en fans et cibler le contenu souhaité sont des impératifs stratégiques. Les chaines de télévision et les groupes de télécommunications se rapprochent et misent sur les contenus afin de se différencier. Par exemple, les amateurs de série s’orientent plus facilement vers l’offre d’un opérateur alors que les fans de football préféreront les contenus d’un autre. Ces industries sont désormais dans le même écosystème, liées par des partenariats. Les utilisateurs et les fans sont alors soigneusement suivis, via leurs données.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('L’analyse des données devient ainsi un levier stratégique pour les entreprises. Plus le consommateur est intéressé plus il produit de données. Or, cette profusion d’informations permet de collecter davantage de renseignements pour mieux appréhender les attentes et les souhaits des utilisateurs. C’est également une manière de mieux cibler un public et de créer de nouvelles opportunités de revenus.') }}
                </p>
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    {{ __('Les business modèles évoluent, les normes aussi') }}
                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Ces partenariats entre les acteurs du secteur des télécommunications et ceux des médias et loisirs donnent une nouvelle dimension de deals aux proportions impressionnantes (megadeals).Les nouveaux leviers : données des utilisateurs, technologies ou encore expériences à faire vivre aux clients permettent d’établir de nouveaux deals stratégiques axés sur la data, l’innovation et le vécu.Les professionnels du jeu et des parcs d’attraction misent eux aussi sur les datas pour améliorer l’expérience utilisateur et espérer contrer les effets de la conjoncture sociale et économique.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Pour ces professionnels des jeux de hasard, sociétés de paris, casinos et parcs d’attractions, la complexité de la régulation et la lutte contre le blanchiment sont d’autres sujets majeurs.De nouvelles normes encadrent désormais tous ces nouveaux usages. L’environnement réglementaire des acteurs du secteur des médias et loisirs se renforce aussi avec de nouvelles règlementations comme IFRS 16 ou le RGPD (Le Règlement Général sur la Protection des Données, entré en vigueur en mai 2018, incitant les entreprises à plus de vigilance dans l’exploitation des données personnelles.).') }}
                </p>
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    {{ __('La France s’inscrit dans la tendance') }}
                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('NKCCG a identifié quatre relais de croissance pour le secteur dans le monde : les services en ligne, la publicité online, les jeux vidéo et la fourniture d’accès Internet.Le marché des médias et loisirs français se trouve également dans une période charnière. Les revenus des secteurs traditionnels ne cessent de baisser au profit des nouveaux entrants digitaux. En France, le développement des accès internet, la vidéo sur internet, la publicité en ligne et les jeux vidéo sont des moteurs de croissance.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Pour la première fois en 2016, la publicité sur internet a généré davantage de revenus que la publicité télévisée. Les consommateurs continuent d’attacher autant d’importance aux deux plateformes alors que les dépenses publicitaires deviennent de plus en plus efficaces.') }}
                </p>
