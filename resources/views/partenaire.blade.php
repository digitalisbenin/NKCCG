...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
  ...
  <main>
    ...
    <section>
            ...
            <div class=" min-h-screen  lg:flex lg:justify-between lg:px-12 py-8  mt-20 h-full"  style="background-color:#e9e9e9 ;">
                <div class="lg:w-1/3">
                    <h1 class="lg:text-4xl lg:mt-9 text-blue-500">{{ __('NOS PARTENAIRES') }}
                    </h1>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('BENIN') }}</a>
                    <p></p>
                    {{-- <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Assemblée Nationale') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Deutsche Gesellschaft für Internationale ') }} <br> Zusammenarbeit (GIZ-Bénin)</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Agence Belge de Développement (Enabel)') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Direction Générale du Trésor et de la  ') }}<br> Comptabilité Publique (DGTCP)
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Direction Générale des Impôts (DGI) ') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Direction Générale de l’Economie (DGE) ') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                    ...
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Société Béninoise d’Energie Electrique (SBEE)') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Société Béninoise de Production d’Electricité (SBPE)') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Autorité de Régularisation de l’Electricité (ARE)') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Office Béninois de Recherches Géologiques ') }}<br> et Minières (OBRGM)
                    </a>
                    <p></p>
                    <a href="#"
                    class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                    {{ __('Agence Nationale d’Identification des  ') }}<br> Personnes (ANIP)
                </a>
                <p></p>
                <a href="#"
                class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                {{ __('Centre National Hospitalier Universitaire ') }}<br> Hubert K. Maga (CNHU-HKM)
            </a>
            <p></p>
            <a href="#"
            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
            {{ __('Centre Hospitalier Universitaire de la Mère ') }}<br> et de l’Enfant Lagune (CHU-MEL)
        </a>
        <p></p>
        <a href="#"
            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
            {{ __('Centre Hospitalier Universitaire de Zone ') }}<br> d’Abomey-Calavi/Sô-Ava (CHUZ-AS)
        </a>
        <p></p>
        <a href="#"
            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
            {{ __('Société des Aéroports du Bénin (SAB) ') }}
        </a>
        <p></p>
        <a href="#"
            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
            {{ __('Université d’Abomey-Calavi (UAC)') }}
        </a>
        <p></p>
        <a href="#"
            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
            {{ __('Université Catholique de l’Afrique de l’Ouest (UCAO) ') }}
        </a>
        <p></p> --}}
        ...
        class="img-fluid avatar-image avatar-image-left" alt="">
                ...
                <div class=" lg:w-1/3 lg:ml-12">
                    <h1 class="lg:text-2xl lg:mt-24"></h1>
                    <a href="#"
                        class="lg:text-xl text-sm lg:mt-4 text-green-600 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('TOGO') }} </a>
                    {{-- <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Assemblée Nationale') }}</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Ministère délégué chargé de l’Enseignement  ') }}<br>Technique et de l’Artisanat (META)</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Autorité de Régulation des Communications ') }}<br>Electroniques et des Postes (ARCEP-Togo)
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                    ...
                    <a href="#"
                        ...
                        {{ __('Ministère de l’Economie et des Finances (MEF)') }}
                    </a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        ...
                        {{ __('Direction Nationale des Assurances (DNA)') }}
                    </a>
                    <p></p>

                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Compagnie Energie Electrique du Togo (CEET)') }}
                    </a>
                    <p></p>

                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Agence Nationale de la Cybersécurité (ANCy)') }}
                    </a>
                    <p></p>

                    <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Société de Gestion d’Intermédiation (SGI-Togo)') }}
                    </a> --}}
        ...
        class="img-fluid avatar-image avatar-image-left" alt="">
                ...
                <div class=" lg:w-1/3 lg:ml-12">
                    ...
                    <p></p>
                    {{-- <a href="#"
                        class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2  border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Ministère de l’Agriculture, de la Pêche ') }}<br> et de l’Environnement, du tourisme et<br>de l’Artisanat</a>
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm lg:mt-6 text-gray-900 hover:bg-orange-500 hover:px-2  border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Direction Nationale des Stratégies Agricoles et de l’Elevage') }}
                    </a>
                   
                    <p></p>
                    <a href="#"
                        class="lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent pb-1 {{ request()->is('aeronautique') ? 'text-blue-700' : '' }}">
                        {{ __('Projet Intégré de Développement des Chaînes de valeurs et de la Compétitivité (PIDC).') }}
                    </a>
                    <p></p> --}}
