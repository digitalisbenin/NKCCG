        ...
        <section class="py-10">
            ...
            <div class="bg-gray-900 text-white py-6">
                <div class="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">
                    <h1 class="text-2xl font-bold mb-2 lg:mb-0">Success</h1>
                    <nav class="text-sm">
                        <ol class="flex space-x-2">
                            <li><a href="/" class="hover:underline">Accueil</a></li>
                            <li class="text-gray-400">/ Success</li>
                        </ol>
                    </nav>
                </div>
            </div>
            
            <section id="call-to-action" class="bg-gray-100 py-12">
                <div class="container mx-auto px-4">
                  <div class="flex flex-col xl:flex-row items-center justify-between text-center xl:text-left" data-aos="zoom-in" data-aos-delay="100">
                    <div class="xl:w-3/4">
                      <h3 class="text-2xl font-semibold text-gray-900">Votre paiement est en cours de validation</h3>
                    </div>
                    <div class="xl:w-1/4 mt-4 xl:mt-0 flex justify-center">
                      @php
                        $idTransaction = request()->query('id_transaction');
                      @endphp
                      <form action="{{ url('mes-cours') }}" method="POST" class="w-full">
                        @csrf
