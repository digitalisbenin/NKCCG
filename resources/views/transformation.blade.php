    ...
    <main>
            ...
            <div class="tc  w-full   ">
                ...
                <div class="  lg:ml-6  lg:mt-72 lg:mr-6 lg:px-20 lg:w-2/3">
                    <h1
                        ...
                        {{ __('Transformation des business models') }}
                    </h1>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3 mx-auto">
                    <div class="inline-block mt-5 ml-8">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des dirigeants français optent en priorité pour la diversification de leur offre') }}
                        </p>
                    ...
                    <div class="inline-block mt-5 mx-4">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des consommateurs attendent que les entreprises se soucient davantage de l’environnement') }}
                        </p>
                    ...
                    <div class="inline-block mt-5 mx-4">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des dirigeants américains déclarent s’inquiéter de la vitesse de l’évolution technologique') }}
                        </p>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            ...
            <div>
                ...
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                    {{ __('De nouvelles tendances, avec un aspect sociétal et technologique de plus en plus prégnant, viennent transformer le marché. Elles changent complètement la donne et peuvent être à l’origine d’une disruption qui oblige les entreprises à repenser leur business model.') }}
                </p>
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                    {{ __('Il est possible d’anticiper ces évolutions, de devenir un acteur des disruptions à venir et d’en faire de véritables opportunités. Trois conditions : avoir la volonté d’aller vers de nouvelles opportunités business, savoir se mettre à la place de son client et être à l’écoute du marché pour en comprendre les besoins latents. Une démarche structurée permettra de développer les modèles économiques ou technologiques qui répondront le mieux à ces attentes.') }}
                </p>
        ...
        <section class=" py-10">
            ...
            <div class=" bg-gray-100  py-10">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-8 py-1 lg:px-10 mb-5  mx-6">
                    {{ __('La disruption : générateur de transformation') }}
                </h2>
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2 mx-6 lg:mx-12 ">
                        ...
                        <div class="">
                            ...
                            <div class=" mt-1">
                                ...
                                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-3">
                                    {{ __('Parmi les grandes disruptions, on compte notamment celles liées à l’accélération de la digitalisation. Les entreprises qui souhaitent tirer parti de cette situation devront se positionner au plus tôt et être à la pointe de ces évolutions.') }}
                                </p>
                                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-3">
                                    {{ __('Les technologies sont une des opportunités à disposition des entreprises pour développer de nouveaux business model, afin de faire évoluer leur métier historique et leur permettre d’être présentes sur de nouveaux marchés.') }}
                                </p>
                                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-3">
                                    {{ __('Anticiper et se préparer à de telles disruptions demande une forte capacité d’analyse, mais l’enjeu justifie ces efforts : une plus grande différenciation sur des marchés très concurrentiels et une résilience accrue sur le long terme.') }}
                                </p>
        ...
        <section class="">
            ...
            <div class=" ">
                ...
                <h1 class="lg:text-4xl text-2xl text-gray-800 lg:mx-5 mx-6 mb-5 lg:ml-20 ">
                    {{ __('Instaurer la confiance à travers l’éthique et la transparence') }}
                </h1>
                    ...
                    <div class="lg:mr-6 mt-5 ">
                        ...
                        <div class=" lg:mt-15">
                            ...
                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide lg:mx-8 text-xl">
                                {{ __('La perte de confiance dans les institutions caractérise l’environnement dans lequel évoluent les entreprises. Cette crise se traduit en particulier par des attentes clients en forte hausse sur les sujets de transparence, de durabilité et de conscience sociale. Les dernières études révèlent que les consommateurs privilégient désormais les produits traçables et respectueux de l’environnement, ainsi que les entreprises aux pratiques durables.') }}
                            </P>
                        </div>
                        ...
                        <div class=" lg:mt-15">
                            ...
                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide  lg:mx-8 text-xl">
                                {{ __('À un moment aussi crucial, il est nécessaire pour les entreprises de se réinventer et d’établir une relation de confiance avec leurs clients potentiels. Cela se traduit par une communication plus transparente, basée sur un discours de preuve (avec le suivi d’indicateurs ESG par exemple), ou encore l’intégration du développement durable dans les lancements produits et dans le calcul de leur retour sur investissement. Le business model doit être en cohérence avec ces pratiques.') }}
                            </P>
                        </div>
