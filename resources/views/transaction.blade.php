    ...
    <main>
        ...
        <section class=" bg-[url('/images/blog-recent-4.jpg')]  lg:bg-cover mt-16" w-800>
            <div class="bg-white">
                ...
                <p class="text-sm mx-5 text-black">{{ __('NKCCG > Nos expertises > Transactions') }}
                </p>
            </div>
            <!-- Bg Shape -->
            <div class="tc  w-full   ">

                <div class="  lg:ml-0  lg:mt-72 mt-24 lg:mr-20 lg:px-2 lg:h-64 bg-gray-800">
                    <h1
                        class="text-4xl text-2xl font-serif lg:text-left ml-9 lg:mr-14 mt-10 mb-5 text-white inline-block px-4">
                        {{ __('Transactions') }}
                    </h1>
                    <h1 class="lg:text-2xl text-xl font-serif lg:text-left ml-9  text-white  lg:mr-64 px-4">
                        {{ __('A chaque étape de vos projets, le pôle Transactions de') }}
                    </h1>
                    <h1 class="lg:text-2xl text-xl font-serif lg:text-left ml-9  text-white  lg:mr-64 px-4">
                        {{ __('NKCCG vous propose des services uniques et des expertises sectorielles.') }}
                    </h1>
                    <div class="ml-9  mt-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class="lg:mx-8 mt-10 mx-6">
            <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 ">
                <div class="lg:mr-6  ">
                    ...
                    <div class="">
                        ...
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-4 ">
                            {{ __('Identification des cibles, évaluation stratégique et financière, négociation, coordination et gestion de processus, conseil en financement, due diligence financière, stratégique et opérationnelle, intégration post-acquisition : nous vous accompagnons à toutes les étapes de vos processus d’acquisition ou de cession, en nous appuyant également sur une expertise sectorielle.') }}
                        </p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-4 ">
                            {{ __('Les entreprises en difficulté sont également accompagnées : diagnostic financier et opérationnel de la situation de l’entreprise, définition et mise en œuvre de différents scénarios de restructuration, recherche de partenaires industriels ou financiers, plans d’optimisation de la trésorerie.') }}
                        </p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-4">
                            {{ __('Depuis plus de 20 ans, le pôle Transactions services de NKCCG, leader en France, intervient chaque année sur plusieurs centaines de transactions. Les équipes françaises comptent environ 300 professionnels expérimentés, s’appuyant sur un réseau mondial Transactions actif dans 70 pays. Les aspects juridiques et fiscaux sont traités par le cabinet d’avocats correspondant, NKCCG Société d’Avocats.') }}
                        </p>
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-4 ">
                            {{ __('Dans le strict respect des règles de confidentialité et d’indépendance, cette expérience unique est mise au service des clients sur chaque mission.') }}
                        </p>
                    </div>
                ...
                <div class="">
                    ...
                    <div class="lg:mx-8">
                        <img src="images/damil-gettyimages-557920759-67020022024.avif"
        ...
        <section class="  bg-gray-100 py-5">
            ...
            <div class=" ">
                ...
                <p class="text-xl font-bold text-gray-400 leading-relaxed  tracking-wide lg:mx-8 mx-6 mb-5 mt-8">
                    {{ __('Vos enjeux stratégiques : due diligence financières, acquisition d’entreprise...') }}</p>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mr-8 mx-6 lg:mx-0 lg:ml-8">
                    <div class=" mt-5 ">
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent lg:h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl ">{{ __('Accompagnement des cessions complexes') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl "> {{ __('Deal Analytics') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <button
                            ...
                            <span class="font-bold text-xl ">
                                {{ __('Enjeux comptables et informations financières liés aux transactions') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl "> {{ __('Fusions-acquisitions') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl">{{ __('Intégration post-acquisition') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span
                                class="font-bold text-xl ">{{ __('Enjeux comptables liés aux transactions') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                    ...
                    <div class="">
                        <div class=" lg:mt-5">
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent lg:h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span
                                    class="font-bold text-xl ">{{ __('Conseil ESG - Développement durable') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent lg:h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span
                                    class="font-bold text-xl ">{{ __('Due diligence acheteur et due diligence vendeur') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent lg:h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl ">{{ __('Évaluation et Business Modelling') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent lg:h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl ">
                                    {{ __('Gestion des difficultés, redressement et restructuration de dettes') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-orange-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl ">{{ __('SPA et contrats') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
        ...
        <section class=" bg-gray-100 py-5">
            ...
            <div class=" ">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-4 lg:mx-12 mx-6">
                    <div class=" mt-5 ">
                        <p class="font-bold text-gray-500 mb-2 text-xl"> {{ __('Pour aller plus loin') }}</p>
                        <img src="images/cq5dam.thumbnail.319.319.webp" alt="" class="mb-2">
                        <p class="text-sm text-gray-800 font-bold mb-2">05/02/24</p>
                        <p class="text-xl text-gray-800">
                            {{ __('Global M&A Industry Trends : tendances et perspectives 2024') }}</p>

                    </div>
                    <div class="">

                        <img src="images/cq5da.webp" alt="" class="mt-12">
                        <p class="text-sm text-gray-800 font-bold mt-2">11/07/23</p>
                        <p class="text-xl text-gray-800">
                            {{ __('Global M&A Industry Trends : tendances et perspectives à mi-année 2023') }}</p>
                    ...
                    <div class="">
                        ...
                        <img src="images/9.webp" alt="" class="mt-12">
                        <p class="text-sm text-gray-800 font-bold mt-2">07/04/23</p>
                        <p class="text-xl text-gray-800">
                            {{ __('Transactions franco-allemandes') }}</p>


                    </div>
                    <div class="">
                        <img src="images/10.webp" alt="" class="mt-12">
                        <p class="text-sm text-gray-800 font-bold mt-2"> 29/03/23</p>
                        <p class="text-xl text-gray-800">
                            {{ __('Tendances et perspectives des fusions et acquisitions en France : industries de santé') }}
                        </p>
                ...
                <div class="flex justify-center items-center">
                    <button type="button"
                        class="py-2.5 px-5 me-2 mb-2  text-lg font-medium text-gray-900 text-center focus:outline-none bg-white border border-gray-200 hover:bg-orange-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200 ">
                        {{ __('Voir plus') }}</button>
                </div>
            </div>
        ...
        <section class="bg-orange-600 mb-10">
            <!-- Bg Shape -->
            <div class="flex   lg:h-44 lg:mx-16 mx-6">
                {{--  <img src="images/icon_phone.webp" class="h-24 mt-6">  --}}

                <div class="">


                    <a href="/contact" class="lg:flex  gi lg:mt-5 lg:ml-4  text-white text-4xl   block">
                        <span class=" font-bold">{{ __('NKCCG vous accompagne dans votre stratégie') }}</span>
                        {{--  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <button
                        class="flex items-center justify-between bg-white text-gray-800 h-12 hover:bg-black hover:text-white  px-4 border border-gray-400 mb-2 ml-5">
                        <span class="font-bold text-lg  mr-8">{{ __('En savoir plus') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                        </svg>
        ...
        {{--  <section class="">
            ...
            <div class=" bg-gray-100 ">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3 mx-12 ">
                            <div class=" mt-5 ">
                               <p class="font-bold text-gray-500 mb-2">Pour aller plus loin</p>
                               <img src="images/img/catalog-image/fichemétier-Actuaire-afrique-oppocmz6jkdei88cxxb171htu1n5j35wf7wa7cb3lc.jpg" alt="" class="mb-2">


                               <p class="text-xl text-gray-800">Gestion des risques financiers : anticiper et gérer les enjeux</p>
                               </div
