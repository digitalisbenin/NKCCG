            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:h-64 bg-gray-800">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left ml-9 mt-12 text-white ">
                        {{ __('Aéronautique, Défense et Spatial') }}
                    </h1>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('nombre d’appareils en backlog pour Airbus en 2022') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('le budget de la mission Défense en hausse de 4,3 % en 2022') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : Ministère des Armées') }}
                    </p>
                </div>
                <div class="lg:w-1/3 ">
                    <div class="border-t-4 border-white mt-6 ml-9 w-12"></div>
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('+29 % de lancements de satellites en 2021, prouvant le dynamisme du secteur spatial') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <p class="text-black text-xl  ">
                        {{ __('Le secteur Aéronautique, Défense & Spatial traverse actuellement une période de transformation, entre une crise sans précédent dans l’aéronautique civile impactant la production et l’emploi, une nécessité de renforcer nos capacités de défense, et un secteur spatial en pleine effervescence qui réinvente son business model.') }}
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2 ">
                    ...
                    <p class="text-black text-xl  mt-4">
                        {{ __('Le spatial est un secteur diversifié aux spécificités multiples, animé par une géopolitique et une dynamique de marché complexes. Le spatial a également des implications importantes dans le cadre plus large de l’économie. Il sert de catalyseur pour les services et les applications dans d’innombrables secteurs industriels et il est essentiel de répondre aux défis et aux besoins croissants en matière de connectivité mondiale, surveillance de l’environnement et sécurité.') }}

                    </p>
                    <a href="/#"
                        class="flex mt-4 gi lg:mt-9 border border-gray-400 lg:w-96 text-black hover:bg-blue-700 block bg-white">
                        <span class="ml-9"> {{ __('Notre expertise dans le secteur spaciale') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <div class="bb ze ki xn 2xl:ud-px-0 mt-6">
            <nav>
                <ul class="tc _o sf yo cg ep">
                    ...
                    <li><a href="/#"
                            class="xl text-white hover:text-orange-500 {{ request()->is('#') ? 'text-blue-700' : '' }}">
                            {{ __('Partenaires') }}

                        </a>
                    </li>
                    <li><a href="#"
                            class="xl text-white hover:text-orange-500 {{ request()->is('#') ? 'text-blue-700' : '' }}">{{ __('Carrières') }}
                        </a>
                    </li>
