...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        <section class=" bg-[url('/images/blog-1.jpg')]  lg:bg-cover mt-16 ">
            <!-- Bg Shape -->
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-44 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left ml-9 mt-12 text-white ">
                        ...
                        {{ __('Distribution et biens de consommation') }}
                    </h1>
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9  text-white">


                        {{ __('Plus avertis, plus exigeants et en quête de sens, les attentes des consommateurs changent et obligent les acteurs du secteur à se transformer. Pour y répondre, de nouveaux modèles de distribution émergent, avec toujours plus de services, de personnalisation et des gammes de produits activement remaniées.') }}
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des consommateurs achètent des produits en ligne au moins une fois par semaine') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des détaillants constatent un déclin de l’enseigne physique dans leur stratégie de distribution') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des Français perçoivent l’importance de consommer des produits respectueux de l’environnement') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <p class="text-black text-xl  ">
                        ...
                        {{ __('Les nouveaux modèles de distribution impliquent des transformations, de nouvelles stratégies et des investissements pour les acteurs du secteur. NKCCG les accompagne.') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('La qualité de l’expérience vécue') }}
                        </li>
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('La data client : un potentiel encore largement inexploité') }}
                        </li>

                    </ul>

                </div>
                <div class="mx-6  lg:w-1/2 mt-4 lg:mt-0">
                    <img src="images/damil-gettyimages-1020592850-670.avif"
        ...
        <section class=" ">
            ...
            <div class=" lg:mx-24 mx-6">
                ...
                <h1 class="lg:text-4xl text-2xl font-serif text-left lg:w-2/4 text-black">

                    {{ __('Distribution et biens de consommation : digital et expérience client') }}
                </h1>
                ...
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    ...
                    {{ __('Le challenge est important car si la technologie est disponible, le pilotage par la donnée nécessite de lourds investissements et pose, en outre, des enjeux règlementaires et de sécurité.') }}
                </p>
                <div class="h-24"></div>
            </div>
        </section>
        <section class="bg-gray-200 ">
            ...
            <div class="  shadow-solid-13  ">
                ...
                <div class="w-full ">
                    ...
                    <div class="lg:flex  mx-6 lg:mx-24  justify-between ">
                        <div class=" ">
                            <img src="images/tsr.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">

                                {{ __('Black Friday 2023 ') }}
                            </p>

                        </div>
                        <div class=" ">
                            <img src="images/1.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                        ...
                        <div class=" ">
                            <img src="images/2.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">

                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">

                                {{ __('Global Consumer Insights Survey ') }}
                            </p>

                        </div>
                        <div class="">
                            <div class="flex ">
                                <img src="images/3.webp" alt="marketing-digital-service-création-de-site-web"
                                    class=" h-44 w-80 ">
                            </div>
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
        ...
        <section class="bg-gray-200 ">
            <div class="h-9"></div>
            <div class="  shadow-solid-13  ">
                <div class="border-t-2 border-gray-300   mx-24 "></div>
                <h2 class="fk vj zp   pr text-xl kk wm qb mt-6  mx-6 lg:mx-24 ">
                    {{ __('Accompagner Pernod Ricard dans l’adoption d’un nouveau CRM') }}
                </h2>
                <div class=" ">

                    <div class="lg:flex mx-6 lg:mx-24 lg:w-1/3 lg:justify-between ">
                        <div class=" ">
                            <img src="images/8.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
        ...
        <section class="bg-white ">
            ...
            <div class="  shadow-solid-13  ">
                ...
                <div class="w-full ">
                    ...
                    <div class="lg:flex mx-6 lg:mx-24 justify-between ">
                        <div class=" ">
                            <img src="images/4.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                        ...
                        <div class=" ">
                            <img src="images/5.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                        ...
                        <div class=" ">
                            <img src="images/6.webp" alt="marketing-digital-service-création-de-site-web"
                                class="h-44 w-80">
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                15/02/22
                            </p>
                        ...
                        <div class="">
                            <div class="flex ">
                                <img src="images/7.webp" alt="marketing-digital-service-création-de-site-web"
                                    class=" h-44 w-80 ">
                            </div>
