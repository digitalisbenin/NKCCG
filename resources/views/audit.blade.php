            ...
            <div class="tc  w-full   ">
                ...
                <div class="  lg:ml-6 mt-32 lg:mt-72 lg:mr-6 lg:px-20 lg:w-2/3">
                    ...
                    <h1 class="text-xl font-serif text-left ml-9  text-white bg-gray-800 lg:mr-64 mr-32 px-4">
                        ...
                        {{ __('Acteur de référence de la création de confiance et de la transformation durable des entreprises') }}
                    </h1>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 ">
                ...
                <div>
                    ...
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                        {{ __('L’expérience au service du Développement') }}</p>
                ...
                <div class="lg:mt-32">
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5 mt-10">
                        {{ __('NKC CONSULTING GROUP, pour l’accomplissement de ses missions, a adopté un référentiel de trois valeurs qui constituent le pilier en matière de comportement du personnel NKC CONSULTING GROUP est un Cabinet d’Etudes et Conseils, d’Audit, d’Audit Technique et de Conseils en Gestion et en Economie, de Formation qui intervient dans les domaines ayant trait à la gestion des Administrations publiques, des Universités et Ecoles Supérieures, des Entreprises industrielles, commerciales et de services, des Projets et Organisations Non Gouvernementales, des Banques, des Sociétés d’Assurance, des Organisations internationales, à l’organisation et à la mise en place de système d’informations et d’outils d’aide à la décision') }}
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 mx-6 ">
                    <div class="lg:mr-6 lg:mt-5 ">
                        ...
                        <div class=" lg:mt-15">
                            ...
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl">
                                {{ __('Forts de la diversité, le Cabinet dispose d’une équipe de consultants pluridisciplinaires compétents, expérimentés (Experts comptables, Ingénieurs en Génie-Civil, Ingénieurs en informations, Ingénieurs réseaux, Experts en Passation des marchés publics, Réviseurs comptables, Fiscalistes, Juristes, Ingénieurs Economistes Planificateurs, Ingénieurs Economistes Statisticiens, Ingénieurs agronomes, Ingénieurs en industrie, Ingénieurs en technologie alimentaire, Ingénieurs en énergie électrique, Ingénieurs en énergie solaire, Ingénieurs en mines et géologie, spécialistes de finances publiques, expert en systèmes d’information, experts en gestion des projets et développement local, Experts en BTP…) et d’outils méthodiques performants utilisés dans le cadre de l’exécution des missions qui lui sont confiées. Sous la direction de son Directeur Général, le Cabinet NKC Consulting Group dispose d’un personnel compétent et dynamique rompu à la tâche et à même de satisfaire les attentes du client sur chaque mission. Intervenant déjà depuis quelques années dans les missions d’Etudes et d’Audit auprès des Organismes financés par des Partenaires au Développement, le Directeur Général du Cabinet NKC Consulting Group et ses collaborateurs, disposent d’une bonne connaissance en matière de direction des missions pour y avoir accumulé une expérience pratique, étendue et variée tant dans le domaine de l’audit, du conseil en gestion que de l’audit technique.') }}
                            </p>
                            </P>
                        </div>
                    </div>
                ...
                <div class="w-full ">
                    ...
                    <div class="lg:flex lg:mx-24 mx-6 justify-between ">
                        <div class=" ">
                            ...
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                {{ __('Accompagner un grand groupe du secteur du transport') }}
                            </p>
                        ...
                        <div class=" ">
                            ...
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                {{ __('Accompagner l’introduction  en bourse de L’Occitane') }}
                            </p>
                        ...
                        <div class=" ">
                            ...
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                {{ __('Accompagner le développement  de la start-up Pretty Simple') }}
                            </p>
                        ...
                        <div class="">
                            ...
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                {{ __('Auditer Agrial à l’international') }}
                            </p>
            ...
            <div class=" bg-gray-100 py-10 ">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-4 lg:mx-12 mx-6">
                    <div class=" mt-5 ">
                        ...
                        <p class="text-xl text-gray-800">{{ __('Les rendez-vous du reporting de durabilité') }}</p>
                    </div </div>
                    <div class="">
                        ...
                        <p class="text-xl text-gray-800">
                            {{ __('Audit à distance – De la crise à des nouveaux leviers de mise en œuvre des plans d’audit interne') }}
                        </p>
