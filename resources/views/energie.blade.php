...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        <section
            class=" bg-[url('/images/collegues-masques-travaillant-ensemble-au-projet-environnement.jpg')]  lg:bg-cover mt-16 ">
            <!-- Bg Shape -->
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-44 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left ml-9 mt-12 text-white ">
                        ...
                        {{ __('Energie et ressources') }}
                    </h1>
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9 mt-4 text-white">

                        {{ __('Transition énergétique, neutralité carbone, efficacité énergétique, transformation digitale et nouveaux business models : le secteur de l’énergie est en pleine mutation.') }}
                    </p>
        ...
        <section class=" bg-red-500">
            <!-- Bg Shape -->
            <div class="lg:flex  mx-6 lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('milliards d’euros d’investissement d’ici 2030') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">

                        {{ __('Source : Ministère de la Transition écologique') }}
                    </p>
                </div>
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('de part d’EnR à atteindre dans la consommation énergétique d’ici 2030') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">

                        {{ __('Source : La transition énergétique pour la croissance verte') }}
                    </p>
                </div>
                <div class="lg:w-1/3 ">
                    <div class="border-t-4 border-white mt-6 ml-9 w-12"></div>
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('de réduction des émissions de gaz à effet de serre en France entre 2015 et 2030') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left text-black">
                        ...
                        {{ __('Vous accompagner dans la transition vers l’énergie de demain') }}
                    </h1>
                    <p class="text-black text-xl mt-4  ">

                        {{ __('Le changement climatique et le besoin croissant de durabilité posent des défis aux entreprises du secteur de l’énergie, des services publics et des ressources. Mais l’avenir promet également de nouvelles opportunités, qu’il s’agisse des avancées dans le domaine des carburants alternatifs, comme l’hydrogène, ou du développement de systèmes énergétiques entièrement nouveaux.') }}
                    </p>
                    <p class="text-black text-xl mt-4">

                        {{ __('Pour prospérer dans cet environnement instable et répondre aux attentes en constante évolution des consommateurs, des investisseurs et des régulateurs, vous devez montrer la voie - tracer le chemin vers un avenir qui sera très différent de celui d’aujourd’hui. Cela signifie qu’il faut réinventer les modèles d’entreprise, redéfinir les marchés, intégrer des technologies durables et fournir de nouveaux produits et services selon de nouvelles modalités, tout en maintenant la confiance dans la fiabilité du système énergétique actuel.') }}
                    </p>
                    <p class="text-black text-xl mt-4 mb-9">

                        {{ __('Les experts de NKCCG comprennent les défis uniques de votre secteur et sont prêts à vous accompagner pour relever les défis de la transition énergétique ainsi que pour saisir les nouvelles opportunités que ce changement apporte.') }}
                    </p>
                </div>
                <div class="mx-6  lg:w-1/2">
                    <img src="images/damil-gettyimages-1125577856-670.avif"
                        alt="marketing-digital-service-création-de-site-web" class="lg:h-96  lg:mb-9">
                </div>
            </div>
        </section>
            ...
            <div class="lg:flex lg:mx-24 mx-6">
                <div class="lg:w-1/2">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left text-black">
                        ...
                        {{ __('Découvrez nos décryptages sur l’hydrogène') }}
                    </h1>
                    <img src="images/damil-gettyimages-1008180008-670.avif"
                        alt="marketing-digital-service-création-de-site-web" class="lg:h-96  mt-6">
                </div>
                <div class="lg:w-1/2 lg:ml-9 lg:mt-24 mt-9">
                    <h1 class="text-2xl font-bold lg:text-left text-black">

                        {{ __('Hydrogène Vert : en quête de financement pour la transition énergétique') }}

                    </h1>
                    <p class="text-black text-xl mt-4  ">

                        {{ __('L’hydrogène vert, clé de la décarbonation énergétique, est confronté à des défis économiques majeurs en Europe, complexifiant le développement projets. Les coûts élevés liés au déploiement des technologies, à la création d’infrastructures et à l’approvisionnement en énergie renouvelable impactent son modèle économique et peinent à concurrencer les coûts de production de l’hydrogène fossile.') }}
                    </p>
                    <p class="text-black text-xl mt-4 ">

                        {{ __('Comment les institutions nationales et l’Union européenne envisagent-t-elles d’accompagner les acteurs (usagers industriels, mobilités, producteurs, etc.) afin de les aider à surmonter ces obstacles financiers et à construire une filière pérenne et décarbonée ?') }}
                    </p>
                </div>
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left text-black">
                        ...
                        {{ __('L’hydrogène : un or vert pour la transition énergétique ?') }}
                    </h1>
                    <p class="text-black text-xl mt-4  ">

                        {{ __('L’émergence de nouvelles filières s’accélère afin de répondre aux enjeux de la transition énergétique : parmi ces dernières, l’hydrogène s’impose comme étant l’une des technologies clés pour sa capacité à décarboner les secteurs émissifs des mobilités et des industries, avec un potentiel d’usages multiples sur le long terme (stockage, chauffage urbain, etc.). Des écosystèmes d’acteurs se mobilisent ainsi au travers d’initiatives territoriales et partenariales afin d’exploiter cette opportunité et d’impulser ce marché d’avenir, qui amène par ailleurs à repenser les modèles de développement des filières émergentes de la transition.') }}
                    </p>
                    <p class="text-black text-xl  ">

                        {{ __('Ecosystems of actors are thus mobilizing through territorial and partnership initiatives in order to exploit this opportunity and boost this market of the future, which also leads to rethinking the development models of emerging transition sectors.') }}
                    </p>
                    <h1 class="text-xl font-bold text-left mt-4 text-black">

                        {{ __('Introduction à la dynamique H2 en France : opportunités, tendances et défis') }}
                    </h1>
                </div>
                <div class="mx-6  lg:w-1/2">
                    <img src="images/gettyimages-183054497_image.jpg"
        ...
        <section class="bg-gray-200 ">
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left text-gray-700">

                        {{ __(' La transition énergétique') }}
                    </h1>
                    <p class="text-black text-xl mt-4  ">

                        {{ __('Quelles tendances et quelles opportunités pour l’économie mondiale ? Les engagements pris par les pays réunis à Paris pour la COP 21 sont aujourd’hui, de l’avis des climatologues, insuffisants pour limiter le réchauffement climatique à 2 degrés Celsius.') }}
                    </p>
                    <h1 class="text-2xl font-bold text-left text-black mt-4">

                        {{ __('Prenez les devants en matière de développement durable') }}
                    </h1>
                    <p class="text-black text-xl mt-4">

                        {{ __('Dans les années à venir, plusieurs grandes tendances vont influencer l’évolution des secteurs de l’énergie, des services publics et des ressources. Outre le changement climatique lui-même, ces tendances comprennent l’épuisement des ressources, des changements majeurs dans le bouquet énergétique mondial, une pression croissante pour parvenir à une consommation nette zéro et des modèles d’entreprise convergents dans tous les secteurs.') }}
                    </p>
                    <h1 class="text-2xl font-bold text-left text-black mt-2">

                        {{ __('Mesures prioritaires') }}
                    </h1>
                    <p class="text-black text-xl mt-4 mb-9">

                        {{ __('Le changement climatique s’accélère et progresse, et les entreprises doivent agir maintenant pour éviter le pire. La société doit également trouver des solutions afin d’éviter l’épuisement de ressources essentielles telles que les métaux de terres rares.') }}
                    </p>
                    <p class="text-black text-xl mt-4 mb-9">

                        {{ __('Les secteurs de l’énergie, des services publics et des ressources sont essentiels pour relever ces défis et mettre le monde sur une voie plus durable. La lutte contre le changement climatique nécessitera une transformation radicale des types de sources d’énergie utilisées pour le transport, le chauffage, la climatisation, l’informatique, les processus industriels, etc. Pour fournir d’autres produits et services vitaux, il faudra innover dans notre façon d’utiliser les ressources, explorer de nouvelles façons de créer de la valeur et passer d’une économie linéaire à une économie circulaire.') }}
                    </p>
                    <h1 class="text-2xl font-bold text-left text-black mt-2">
                    ...
                    <p class="text-black text-xl mt-4 mb-9">
                        ...
                        {{ __('Les citoyens doivent pouvoir avoir confiance dans le fait que les entreprises du secteur de l’énergie, des services publics et des ressources continueront à leur fournir les services essentiels, de l’électricité à l’eau en passant par toutes les technologies, tous les produits et tous les services basés sur les ressources dont le monde dépend, et ce de manière abordable, fiable et durable.') }}
                    </p>
                    <p class="text-black text-xl mt-4 mb-9">

                        {{ __('Parallèlement, la transition vers des sources d’énergie et de ressources naturelles plus vertes et plus durables signifie que la société et l’économie devront s’adapter à de nouveaux modes de vie et de travail. Il s’agira notamment d’abandonner progressivement les véhicules, les centrales électriques et les autres technologies qui dépendent actuellement des combustibles fossiles ou d’autres ressources non renouvelables. Cela nécessitera des innovations et des investissements considérables de la part de nombreuses industries à court et à moyen terme.') }}
                    </p>
                    <h1 class="text-2xl font-bold text-left text-black mt-2">
                    ...
                    <p class="text-black text-xl mt-4 mb-9">
                        ...
                        {{ __('Grâce à l’augmentation spectaculaire de l’accessibilité et de l’efficacité des technologies d’énergie renouvelable, la voie vers un avenir sans émissions nettes est réalisable. Un nombre croissant de pays dans le monde se sont fixé des objectifs d’émissions nettes nulles. Cependant, la fenêtre d’opportunité pour atteindre l’objectif de zéro émission nette au niveau mondial est étroite et se rétrécit rapidement, en partie parce que la mise en place des infrastructures nécessaires à un avenir plus durable prendra des décennies. Il est donc important d’agir maintenant.') }}
                    </p>
                    <p class="text-black text-xl mt-4 mb-9">

                        {{ __('Pour atteindre le net zéro, il faudra que les entreprises des secteurs de l’énergie, des services publics et des ressources fassent preuve de leadership, de même que les décideurs politiques, les instituts de recherche, les investisseurs, les organisations transnationales et autres acteurs. Il faudra également une volonté politique, des investissements et des efforts suffisants dans le monde pour réaliser la transition vers des services et des technologies à zéro émission nette.') }}
                    </p>
                    <p class="text-black text-xl mt-4 mb-9">

                        {{ __('Les experts de NKCCG possèdent les connaissances et l’expertise nécessaires pour vous accompagner sur ces sujets.') }}
                    </p>
                </div>
                <div class="mx-6  lg:w-1/2">
                    <img src="images/damil-gettyimages-970436208-6702.avif"
                        alt="marketing-digital-service-création-de-site-web" class="lg:h-96  mb-9">
                </div>
            </div>
        </section>
            ...
            <div class=" lg:h-44 lg:mx-24 mx-6 ">
                <div class="">
                    ...
                    <h1 class="text-2xl font-bold text-left text-white mt-2">
                        ...
                        {{ __('Economie verte et hydrogène : prédire l’agenda de décarbonation de demain') }}
                    </h1>
                    <a href="/#" class="flex gi lg:mt-4 w-52    text-black bg-white hover:bg-blue-700 block">
                        <span class="ml-9">{{ __('En savoir plus') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class="bg-gray-200 ">
            ...
            <div class="  shadow-solid-13  ">
                <h2 class="fk vj zp   pr text-xl kk wm qb mx-6 lg:mx-24 ">{{ __('Nos clients témoignent') }}
                </h2>
                <div class="w-full ">
