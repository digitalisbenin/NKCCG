...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        ...
        <section class=" bg-[url('/images/groupe-afro.webp')]  lg:bg-cover mt-16" w-800>
            <div class="bg-white">
                <p class="text-sm mx-5 text-black">
                    {{ __('NKCCG > Et vous, quelle équation voulez-vous résoudre ? > Startups et grands groupes : collaborez pour innover') }}
                </p>
            </div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3 mx-auto">
                    <div class="inline-block mt-5 ml-8">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('startups en France, qui représentent un million d’emplois') }}
                        </p>
                    ...
                    <div class="inline-block mt-5 lg:mx-4 ml-8 lg:ml-0">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('licornes françaises en 2022, dont 12 nouvelles en 2021') }}
                        </p>
                    ...
                    <div class="inline-block mt-5 lg:mx-4 ml-8 lg:ml-0">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('startups du French Tech Next40/120 introduites en bourse en 2021') }}
                        </p>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2 mx-6 lg:mx-8">
                <div>
                    ...
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl ">
                        {{ __('Le nombre de licornes françaises a déjà dépassé l’objectif fixé pour 2025 alors que la promotion 2022 des startups du Next 40/120 a été annoncée fin janvier.') }}
                    </p>
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5 ">
                        {{ __('Ces scale ups constituent l’un des grands viviers de champions pour assurer la souveraineté économique et technologique de la France et de l’Europe.') }}
                    </p>
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                        {{ __('Dirigeant d’une startup, vous devez gérer le passage à l’échelle en tenant compte à la fois des problèmes qui sont ceux d’une entreprise classique et des contraintes qui vous sont propres. Cette complexité accrue ne vous donne aucun droit supplémentaire à l’erreur. Vous impulsez un rythme qui incite l’ensemble des acteurs de l’économie à se transformer plus vite, à revoir leurs modèles économiques.":"') }}
                    </p>
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                        {{ __('Membre d’un grand groupe, vous souhaitez accélérer l’innovation en bénéficiant de l’écosystème des startups.') }}
                    </p>
                    <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                        {{ __('Nous nous engageons auprès des startups et grands groupes dans le monde entier en soutenant les entrepreneurs qui cherchent à concrétiser leurs idées et à créer des entreprises durables.') }}
                    </p>
        ...
        <section class=" py-10">
            <h1 class=" lg:text-4xl text-2xl lg:ml-10 mb-5 mx-6 lg:mx-0 text-gray-800">
                {{ __('Personnaliser votre expérience') }}
            </h1>
                ...
                <div class="lg:px-5">
                    <div class="flex items mb-4">
                        ...
                        <div>
                            ...
                            <p class="ml-5">(Serie A, Serie B)</p>
                        </div>
                    </div>
                    <p class=" font-bold text-gray-800 text-lg mb-4 ">
                        {{ __('Un programme pour rencontrer vos futurs clients') }}</p>
                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('Le programme Scale de NKCCG facilite la collaboration commerciale entre les startups et les grands groupes :10 startups, 10 semaines, 30 grands groupes.') }}
                    </p>

                    <button type="button"
                        class=" py-2.5 px-5 me-2 mb-2  text-lg font-bold text-white text-center focus:outline-none bg-orange-700 border border-gray-400 hover:bg-transparent hover:text-gray-600 focus:z-10 focus:ring-4 focus:ring-gray-200 ">{{ __('Le programme Scale') }}</button>
                </div>
                <div class="px-5">
                    <div class="flex items mb-4">
                        <img class=" " alt="" style="background-color: transparent;"
                        ...
                        <div>
                            ...
                            <p class="ml-5">(Serie C et +, Next 40 I FT120)</p>
                        </div>
                    </div>
                    <p class=" font-bold text-gray-800 text-lg mb-4"> {{ __('Un accompagnement sur-mesure pour') }}
                    </p>
                    <p class=" font-bold text-gray-800 text-lg mb-4">{{ __('passer à l’échelle') }}</p>
                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('NKCCG, partenaire des sociétés innovantes, propose un accompagnement sur-mesure par le biais d’un programme dédié aux scale ups.') }}
                    </p>
                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('A vos côtés pour répondre aux enjeux de l’hypercroissance à l’échelle des acteurs de demain.') }}
                    </p>
                </div>
                <div class="px-5">
                    ...
                    <div class="flex items mb-4">
                        ...
                        <div>
                            <h3 class="font-bold lg:text-3xl text-2xl text-gray-800 ml-5 mb-10 ">
                                {{ __('Grands groupes et pouvoirs publics') }}
                            </h3>


                        </div>
                    </div>
                    <p class=" font-bold text-gray-800 text-lg mb-4">{{ __('Une offre unique pour bénéficier de') }}
                    </p>
                    <p class=" font-bold text-gray-800 text-lg mb-4">{{ __('conseils en innovation') }}</p>
                    <p class="text-gray-800 mb-5 leading-relaxed  tracking-wide  text-xl">
                        {{ __('Révéler des synergies, grâce à une offre permettant de trouver les meilleurs partenaires, assurer une collaboration fiable et sécurisée pour répondre à vos enjeux : nos experts vous accompagnent.') }}
                    </p>
                    <button type="button"
                        class=" py-2.5 px-5 me-2 mb-2  text-lg font-bold text-white text-center focus:outline-none bg-orange-700 border border-gray-400 hover:bg-transparent hover:text-gray-600 focus:z-10 focus:ring-4 focus:ring-gray-200 ">{{ __('Grands groupes et pouvoirs publics') }}</button>
                </div>
            </div>
        </section>
        <section class="bg-gray-50 py-10">
            <h1 class=" lg:text-4xl text-2xl mx-6 lg:mx-0 lg:ml-10 text-gray-800">
                {{ __('Un réseau d’experts à votre disposition') }}</h1>
            <div class=" grid gap-6 mb-6 md:grid-cols-2 mx-6 lg:mx-auto">
                <div class="mt-10">

                    <p class="lg:ml-10 mb-5 text-lg text-gray-800">
                        {{ __('Plus de 500 spécialistes dédiés au secteur des startups dont 40 personnes en France vous accompagnent dans votre transformation.') }}
                    </p>

                    <div class="lg:ml-10">
                        <a href="/#"
                            class="flex gi lg:mt-4 w-48   text-white bg-orange-600 hover:bg-white hover:text-gray-800 border border-gray-800 block">
                            <span class="ml-9 font-bold "> {{ __('Contactez-nous') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class="">
            ...
            <div class="py-10 lg:ml-10 ">
                ...
                <h2 class="text-4xl text-gray-800 lg:mx-5 mx-6  mb-5 lg:ml-20 ">
                    {{ __('NKCCG au coeur de l’écosystème') }}</h2>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 mx-6">
                    <div class="lg:mr-6 mt-5 ">
                        ...
                        <div class=" mt-1">
                            ...
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5 ">
                                {{ __('Le partenariat avec Slush est l’illustration de l’engagement de NKCCG auprès de l’écosystème des sociétés innovantes.') }}
                            </p>
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5 ">
                                {{ __('L’organisation à but non lucratif Slush met en relation des entrepreneurs et des talents technologiques avec des investisseurs de renom, des sociétés multinationales, des entreprises familiales, des particuliers cherchant à investir et les médias.') }}
                            </p>
                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-10 font-bold ">
                                {{ __('NKCCG travaille en partenariat avec Slush depuis 2010, devenant en 2015 leur premier partenaire au niveau mondial.') }}
                            </p>
                            ...
                            <a href="/#"
                                ...
                                <span class="ml-9 font-bold ">{{ __('Slush et NKCCG') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class=" py-5 bg-gray-100">
            ...
            <div class=" ">
                ...
                <p class="text-xl font-bold text-gray-400 leading-relaxed  tracking-wide mx-6 lg:mx-8 mb-5 mt-8">
                    {{ __('Quelles autres équations voulez-vous résoudre ?') }}</p>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mr-8 mx-6 lg:mx-0 lg:ml-8">
                    <div class=" lg:mt-5 ">
                        ...
                        <button
                            ...
                            <span class="font-bold text-xl "> {{ __('Transition écologique et sociétale') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        ...
                        <button
                            ...
                            <span class="font-bold text-xl ">
                                {{ __('Culture et responsabilité d’entreprise') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl "> {{ __('Création et préservation de valeur') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl ">
                                {{ __('Croissance des entreprises familiales/ETI') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                    ...
                    <div class="">
                        <div class=" lg:mt-5">
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl "> {{ __('Technologie et performance') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl ">
                                    {{ __('Transparence et maîtrise des risques') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl">
                                    {{ __('Transformation des business models') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl"> {{ __('Startups et innovation') }} </span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
        ...
        <section class="">
            ...
            <div class="  shadow-solid-13  ">
                <h2 class="fk vj zp   pr text-xl kk wm qb mx-6 lg:mx-24 text-gray-500 ">
                    {{ __('Pour aller plus loin') }}
                </h2>
                <div class="w-full ">
