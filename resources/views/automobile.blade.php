            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 lg:w-2/3 lg:px-20 mt-32 bg-gray-800">
                    ...
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9  text-white">
                        {{ __('L’évolution des technologies, la mise à place de nouvelles réglementations et les changements dans les comportements des clients bouleversent l’industrie automobile. Nos experts analysent le marché automobile et délivrent une vision précise du secteur et des tendances à venir aux constructeurs, équipementiers et distributeurs.') }}
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24 mx-6">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des consommateurs seront prêts à payer 250$ un abonnement mensuel de trajets illimités en ville') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('des ventes mondiales seront représentées par les véhicules électriques d’ici 2030.') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('de ventes de véhicules 5G sont attendues dans l’UE, aux États-Unis et en Chine d’ici 2030') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
            ...
            <div class="lg:flex">
                <div class="lg:mx-24 mx-6 lg:w-1/2 ">
                    <p class="text-black text-xl  ">
                        ...
                        {{ __('Technologies, nouvelles formes de mobilité et innovations sont au centre des stratégies des acteurs de l’automobile accompagnés par NKCCG.') }}
                    </p>
                    <ul class="  text-black list-inside mt-16 lg:ml-9 text-lg">
                        <li class="flex items-center">
                            ...
                            {{ __('Accompagner les évolutions du secteur') }}
                        </li>
                        ...
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('Repenser l’expérience client') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
