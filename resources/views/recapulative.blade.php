        ...
        <section class="py-10">
            ...
            <div class="bg-gray-900 text-white py-6">
                <div class="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">
                    <h1 class="text-2xl font-bold mb-2 lg:mb-0">Récapitulatives</h1>
                    <nav class="text-sm">
                        <ol class="flex space-x-2">
                            <li><a href="/" class="hover:underline">Accueil</a></li>
                            <li class="text-gray-400">/ Récapitulatives</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row text-center mb-8">
                        <div class="col-12">
                            <div class="section-title gray-bg">
                                <h2 class="text-3xl font-semibold text-gray-800" data-wow-delay=".4s">Récapulative</h2>
                                <!-- <p class="text-gray-600 mt-4" data-wow-delay=".6s"></p> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="col-lg-12 col-md-6 col-12">
                            <table id="studentTable" class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                                <thead>
                                    <tr>
                                        <th class="px-4 py-2 text-sm text-gray-900">Quiz</th>
                                        <th class="px-4 py-2 text-sm text-gray-900">Formation / Module</th>
                                        <th class="px-4 py-2 text-sm text-gray-900">Note</th>
                                        <th class="px-4 py-2 text-sm text-gray-900">Appréciation</th>
                                        <th class="px-4 py-2 text-sm text-gray-900">Certificat</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($notequiz as $value)
                                        @php
                                            ...
                                            $appreciationClass = $isSuccess ? 'bg-green-500 text-white' : 'bg-red-500 text-white'; // Classe CSS dynamique
                                        @endphp
                                        <tr>
                                            <!-- Affichage du titre du quiz -->
                                            <td class="px-4 py-2 {{ $appreciationClass }} text-center">
                                            ...
                                            <td class="px-4 py-2 {{ $appreciationClass }} text-center">
                                                <span class="h6 mb-0 fw-medium">
                                                    @if( $isSuccess )
                                                        <a href="{{ route('certificate.download', $chapitre->id) }}" class="inline-block px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all">Télécharger le certificat</a>
                                                    @endif
                                                </span>
                                            </td>
                                        </tr>
