            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    ...
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9 mt-4 text-white">
                        {{ __('Traditionnellement confronté à de faibles marges et à des niveaux de risques importants, le secteur de l’ingénierie et de la construction doit faire face à de nouveaux défis tout en restant largement dépendant des budgets d’investissement de l’Etat et des collectivités publiques.') }}
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('de croissance annuelle de la taille du marché des Smart Cities de 2017 à 2022') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('des entreprises françaises ont souscrit à des services de Threat Intelligence') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : La construction à l’heure de la cybercriminalité') }}
                    </p>
                </div>
                <div class="lg:w-1/3 ">
                    <div class="border-t-4 border-white mt-6 ml-9 w-12"></div>
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('des start-up du secteur jugent les processus de prise de décision des grands groupes trop longs') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
            ...
            <div class="lg:mx-24 mx-6 lg:flex">
                <div class="lg:w-1/2 lg:mr-4">
                    <p class="text-black text-xl  ">
                        {{ __('Les acteurs du secteur de l’ingénierie et de la construction font face à de nouveaux enjeux. NKCCG les accompagne.') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            ...
                            {{ __('Une perspective de croissance pour la France ?') }}
                        </li>
        ...
        <section class=" ">
            ...
            <div class="mx-6 lg:mx-24">
                ...
                <h1 class="lg:text-4xl text-2xl font-serif text-left  text-black">
                    {{ __('Ingénierie et construction : des chantiers porteurs') }}
                </h1>
                ...
                <p class="text-black  mt-6 lg:w-2/4 text-lg">
                    {{ __('Le secteur de l’ingénierie et de la construction participe à la bonne santé de l’économie française. Les experts de NKCCG estiment qu’1 milliard d’euros investi dans le secteur générerait 2,3 milliards d’euros de revenus additionnels pour l’économie française*.') }}
                </p>
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    {{ __('Des projets phares') }}
                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Le secteur reste dépendant de la gestion des budgets d’investissement de l’Etat et des collectivités locales. En France, malgré l’augmentation de la dette publique, l’Etat maintient une politique de grands travaux. Après les récents chantiers LGV (Ligne à Grande Vitesse), l’émergence de grands projets devrait permettre de relancer la croissance et de générer des emplois, mais exposent en contrepartie le secteur à une raréfaction de la main d’œuvre notamment qualifiée.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Cinq grands projets ont démarré en France : EDF Grand carénage, le Grand Paris, le projet Cigéo, le Canal de Seine Nord et les Jeux Olympiques de 2024. Ces projets pourraient permettre de créer plus de 84 000 emplois par an sur la quinzaine d’années à venir. Par exemple, l’accueil des Jeux Olympiques d’été en 2024 à Paris engendrera un investissement de 3 milliards d’euros sur 7 ans et plus de 5 000 emplois potentiels par an.') }}
                </p>
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
                    {{ __('Un secteur en mouvement') }}
                </h1>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Plus fondamentalement, l’évolution démographique et l’urbanisation rapide participent activement à la progression de l’activité. En matière de logements 28 « zones tendues » ont été définies dans lesquelles l’offre est insuffisante par rapport à la demande. Autant de zones où le besoin en constructions neuves est fort.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    {{ __('Autres facteurs favorables à l’activité du secteur : le plan de rénovation énergétique et les nouvelles technologies. Rénover le parc immobilier ancien devrait porter également le secteur et créer des opportunités pour les acteurs du marché. Tout comme la domotique et les nouvelles technologies qui accélèrent les procédés de construction (impression 3D) ou améliorent la performance du suivi de chantier (applications, modélisation des données du bâtiment…).') }}
                </p>
