...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        <section class=" bg-[url('/images/usine-vinificateur-contemporain.jpg')]  lg:bg-cover mt-16 ">
            <!-- Bg Shape -->
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 mt-32 lg:mr-6 lg:px-20 lg:w-2/3 bg-gray-800">
                    ...
                    <p class="lg:text-2xl text-xl font-serif text-left ml-9 mt-4  text-white">
                        {{ __('Réformes de santé, évolutions sociodémographiques, apparition de nouveaux équipements numériques : les différents acteurs de la santé s’appuient sur ces mutations pour passer progressivement d’un système curatif à un système préventif.') }}
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('place occupée par la France parmi les pays producteurs de médicaments en Europe') }}
                    </p>
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('L’approche « patient-centric » est au premier plan du système de santé en évolution') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('des managers des industries de santé entendent investir dans l’IA dans les 3 ans') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
                ...
                <div class="lg:w-1/4 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        {{ __('million de personnes âgées dépendantes en 2030 en France') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        {{ __('Source : étude NKCCG') }}
                    </p>
            ...
            <div class="lg:mx-24  mx-6 lg:flex">
                <div class="lg:w-1/2 lg:mr-4">
                    <p class="text-black text-xl  ">
                        {{ __('L’environnement économique mondial des industries de santé a évolué considérablement, accélérant la transformation du secteur. Cette « nouvelle économie de la santé » fait face à de nombreux enjeux.') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            ...
                            {{ __('Pression croissante sur les prix des médicaments') }}
                        </li>
                        <li class="flex items-center mt-6">
                            ...
                            {{ __('Avancées scientifiques et technologiques') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Accès aux soins de plus en plus global') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700  flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Montée en puissance des marchés émergents') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700  flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Exigences comptables, fiscales et règlementaires fortes transformant l’écosystème actuel') }}
                        </li>
                    </ul>
                </div>
                <div class="lg:w-1/2 mt-4 lg:mt-0">
                    <img src="images/fr-555x312-istock-614517514.webp" class="">
                </div>
            </div>
            <div class="h-6"></div>
            ...
            <div class=" lg:mx-24 lg:flex mx-6">
                <div class="lg:w-1/2">
                    <h1 class="lg:text-4xl text-2xl font-serif text-left  text-black">
                        {{ __('L’avenir de la conformité dans l’industrie pharmaceutique') }}
                    </h1>
                    <h1 class="text-2xl font-bold text-left mt-4  text-black">
                        {{ __('Comment la stratégie, la technologie et l’éthique s’associent pour répondre aux enjeux de demain ?') }}
                    </h1>

                    <p class="text-black  mt-6  text-lg">
                        {{ __('La conformité dans l’industrie pharmaceutique est en pleine transformation sous l’effet de six forces externes clés : le juridique, la finance, l’innovation technologique et médicale, la culture, l’éducation et la démographie.') }}
                    </p>
                    <p class="text-black  mt-6  text-lg">
                        {{ __('Développé par NKCCG en collaboration avec des responsables de la conformité de l’ensemble du secteur dans différents pays européens, ce livre blanc décrypte les enjeux, les priorités et les principaux défis auxquels sont confrontés les responsables de la conformité dans l’industrie pharmaceutique, ainsi que sur les tendances émergentes, les risques et les implications commerciales.') }}
                    </p>

                </div>
                <div class="lg:w-1/2 lg:ml-12">
                    <p class="text-black text-xl  ">
                        {{ __('Ce livre blanc vous permettra de :') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                            ...
                            {{ __('Comprendre les principaux défis d’aujourd’hui.') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700  flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Découvrir des retours d’expériences en matière d’interactions avec les partenaires commerciaux et les professionnels de santé, les avantages attendus et les meilleures pratiques.') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Bénéficier de nos recommandations pour réussir votre programme de transformation de la conformité pharmaceutique.') }}
                        </li>
        ...
        <section class="bg-white ">
            ...
            <h1 class="lg:text-4xl text-2xl font-serif text-left lg:mx-24 text-black mx-6">
                {{ __('5 recommandations pour rendre la prévention efficace en France ') }}
            </h1>
            <div class="lg:mx-24 lg:flex mt-9">
                <div class="lg:w-1/2 lg:mr-4 mx-6">

                    <p class="text-black text-xl mt-4 ">
                        {{ __('Elisabeth Hachmanian et Renaud Vignon, associés Consulting santé NKCCG France et Maghreb, ont contribué au Think Tank Economie Santé Les Echos pour porter un nouveau regard sur les enjeux de prévention en santé.') }}
                    </p>
                    <p class="text-black text-xl mt-4 ">
                        {{ __('Comment rendre la prévention efficace en France ? Leurs réflexions ont mené à cinq recommandations adressées au gouvernement.') }}
                    </p>
                    <ul class="  text-black list-inside mt-9 text-lg ">
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                            ...
                            {{ __('A partir des territoires, clarifier les responsables et le pilotage') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700  flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Sanctuariser le financement') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700 flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Impliquer les citoyens en rénovant la démocratie sanitaire') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700  flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Mobiliser le système de soins') }}
                        </li>
                        <li class="flex items-center mt-6">
                            <svg class="w-3.5 h-3.5 me-2 text-orange-700  flex-shrink-0" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {{ __('Innover avec le Numérique en santé') }}
                        </li>
                    </ul>
                </div>
                <div class="lg:w-1/2 mt-4 lg:mt-0 mx-6">
                    <img src="images/fr-555x312-istock-614517514.webp" class="">
                </div>
            </div>
            <div class="h-6"></div>
        ...
        <section class="bg-gray-200 ">
            <div class="lg:h-12 h-6"></div>
            <h1 class="lg:text-4xl text-2xl font-serif text-left lg:mx-24 mx-6 text-black">
                {{ __('Le Health Research Institute (HRI) de NKCCG') }}
            </h1>
            <div class="lg:mx-24 lg:flex mt-9 mx-6">
                <div class="lg:w-1/2">
                    <img src="images/health-research-institute-pageimg.avif" class="">
                </div>
                <div class="lg:w-1/2 lg:ml-6">
                    <h1 class="lg:text-2xl text-xl font-bold text-left text-black">
                        {{ __('Vous fournir de nouvelles informations, perspectives et analyses sur les tendances des industries de Santé pour un leadership éclairé') }}
                    </h1>
                    <p class="text-black text-xl mt-4 ">
                        {{ __('En tant que décideur dans la Santé, vous êtes face à une industrie très dynamique, dont la chaîne de valeur est constamment remaniée par les innovations technologiques, la réglementation évolutive et les nouveaux modes de consommation. Le HRI peut vous aider à appréhender ces changements grâce à la Recherche et aux échanges collaboratifs. Nos opinions sont façonnées par un réseau de professionnels de la Santé qui ont une expérience de direction ou qui travaillent au quotidien sur des problématiques concrètes.') }}
                    </p>
            ...
            <div class=" lg:h-44 lg:mx-24 mx-6">
                <div class="">
                    ...
                    <h1 class="lg:text-2xl text-xl font-bold text-left text-white mt-2">
                        {{ __('Enjeux du secteur de la Santé : décryptage en vidéo de Cédric Mazille, Associé - Responsable des industries de Santé') }}
                    </h1>
