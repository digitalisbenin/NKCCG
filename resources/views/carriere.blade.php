...
<div class="min-h-screen  lg:flex lg:justify-between lg:px-12 py-8  mt-20 "  style="background-color:#e9e9e9 ;">
                                    <div>
                                        <h1 class="lg:text-4xl text-sm lg:mt-16 text-blue-500">{{ __('CARRIERES') }}
                                        </h1>
                                        <a href="#"
                                            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('#') ? 'text-blue-700' : '' }}">
                                            {{ __('Pourquoi faire le choix de NKCCG ?') }} </a>
                                            <p>En choisissant NKCCG, vous bénéficiez d’une expertise approfondie dans les domaines des études, de la formation, des services, des finances publiques<br> et de la gestion, du management et organisation, de conseils stratégiques et opérationnels, de la planification, du diagnostic et de l’évaluation, de la conception<br> et de la mise en place de système, du développement durable et de la responsabilité sociale, de la technologie et de l’ingénierie, de la représentation <br>et du partenariat.</p>
                                        <a href="#"
                                            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('#') ? 'text-blue-700' : '' }}">
                                            {{ __('Quel métier est fait pour moi ?') }}</a>
                                        <p>Nous vous offrons une gamme complète de services pour répondre aux exigences de votre organisation </p>
                                        <ul class="space-y-4 text-gray-700">
                                            <li class="flex items-start">
                                              <span class="text-blue-500 text-xl mr-2">•</span>
                                              <strong>Audit et Conseil :</strong> Des analyses détaillées et des recommandations pratiques pour améliorer la performance de votre organisation.
                                            </li>
                                            <li class="flex items-start">
                                              <span class="text-blue-500 text-xl mr-2">•</span>
                                              <strong>Stratégie :</strong> Élaboration et mise en œuvre de stratégies efficaces pour accompagner la croissance de votre entreprise.
                                            </li>
                                            <li class="flex items-start">
                                              <span class="text-blue-500 text-xl mr-2">•</span>
                                              <strong>Formations :</strong> Des programmes de formation personnalisés pour développer les compétences de vos équipes et les préparer aux défis actuels.
                                            </li>
                                            <li class="flex items-start">
                                              <span class="text-blue-500 text-xl mr-2">•</span>
                                              <strong>Informatique :</strong> Solutions innovantes pour optimiser votre infrastructure IT et renforcer la cybersécurité.
                                            </li>
                                            <li class="flex items-start">
                                              <span class="text-blue-500 text-xl mr-2">•</span>
                                              <strong>Finance Publique et Fiscalité :</strong> Expertise en gestion des finances publiques et conformité fiscale pour améliorer vos opérations financières.
                                            </li>
                                          </ul>
                                        <a href="/contact"
                                            class="lg:text-xl lg:mt-4 text-sm text-gray-900 hover:bg-orange-500 hover:px-2 whitespace-nowrap inline-block border-b-4 border-transparent pb-1 {{ request()->is('contact') ? 'text-blue-700' : '' }}">
                                            {{ __('Échanger avec nos collaborateurs') }}</a>
                                        <p></p>
