    ...
    <main>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3 mx-auto">
                    <div class="inline-block mt-5 ml-8">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des dirigeants prévoient d’investir dans la transformation digitale') }}

                        </p>
                        <p class="text-sm my-5">{{ __('Source : Etude NKCCG - Global CEO Survey 2021') }}</p>

                    </div>

                    <div class="inline-block mt-5 mx-4">
                        <div class="border-t-2 border-white w-[3.5rem] h-[1rem]"></div>
                        <h1 class="text-4xl">4 200 Mds de $</h1>
                        <p class="my-2 text-xl">
                            {{ __('de dépenses informatiques mondiales en 2021, soit 8,6 % de plus qu’en 2020') }}

                        </p>

                        <p class="text-sm my-5">{{ __('Source : Gartner Forecasts 2021 - Worldwide IT Spending') }}
                        </p>
                    </div>
                    ...
                    <div class="inline-block mt-5 mx-4">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des dirigeants considèrent le cloud comme stratégique pour la croissance et l’innovation') }}
                        </p>

                        <p class="text-sm my-5">{{ __('Source : NKCCG US Cloud Business Survey 2021') }}</p>
                    </div>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            ...
            <div>
                ...
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                    {{ __('Investir dans la technologie est déjà une priorité pour les dirigeants cherchant à accroître la performance et l’agilité de leur entreprise – deux avantages compétitifs prédominants pour les dix prochaines années. Pour tirer parti des opportunités offertes par des technologies telles que le cloud, l’intelligence artificielle (IA), la robotic process automation (RPA) ou encore la blockchain, les organisations doivent monter en compétence et transformer en profondeur leur modèle opérationnel. Au-delà des aspects techniques, il est également crucial de se préoccuper des questions liées à l’éthique, la fiscalité et la souveraineté. L’objectif commun est que ces évolutions vers un monde toujours plus connecté soient vécues comme facteurs de progrès.') }}
                </p>
        ...
        <section class=" py-10">
            ...
            <div class=" bg-gray-100  py-10">
                ...
                <h2 class="lg:text-4xl text-xl text-gray-800 lg:mx-8 mx-6 py-1 lg:px-10 mb-5   ">
                    {{ __('Assurer sa transformation grâce à la technologie') }}</h2>



                <div class=" lg:mx-12 mx-6 mt-5 lg:flex ">
                    <div class="lg:mr-6 mt-5 lg:w-1/3 ">
                        <button
                            class="flex items-center justify-between bg-red-700 h-16 lg:w-2/3 lg:ml-10 lg:px-4 border border-gray-400 mb-2">
                            <span class=" text-xl text-white">{{ __('Se différencier par l’innovation') }}</span>
                        ...
                        <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 mb-4">
                            {{ __('Répondre aux ambitions de croissance et mettre en place de nouveaux business models') }}
                        </p>
                    ...
                    <div class=" lg:w-2/3 ">
                        <div class=" mt-5">
                            <h3 class="lg:text-4xl text-2xl font-bold text-gray-800 mb-5   lg:mx-7">
                                {{ __('Se différencier par l’innovation') }}
                            </h3>
                            <p class="text-gray-800 leading-relaxed  tracking-wide   lg:mx-8 mb-4">
                                {{ __('Innover pour faire face à des défis majeurs – qu’ils soient environnementaux, sanitaires, économiques ou sociétaux – implique de s’adapter et de prendre en compte tout l’écosystème lié à une technologie. Innover, c’est parfois aussi travailler de manière collaborative avec ses concurrents (coopétition au sein de consortiums ou conglomérats) afin de gagner en agilité et en compétitivité.') }}
                            </p>
        ...
        <section class="">
            ...
            <div class=" ">
                ...
                <h1 class="lg:text-4xl text-2xl text-gray-800 mx-5 mb-5 lg:ml-20">
                    {{ __('La technologie : un facteur clé de confiance') }}</h1>


                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 mx-6">
                    <div class="lg:mr-6 mt-5 ">
                        <h2 class="lg:text-3xl text-xl font-bold text-gray-800 lg:mx-5 mb-5 ">
                            {{ __('Anticiper les menaces et préserver la confiance') }}</h2>

                        <div class=" mt-15">

                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide lg:mx-8 text-xl">
                                {{ __('Les risques auxquels les organisations sont confrontées sont chaque jour plus nombreux et plus complexes : attaques par ransomwares, groupes malveillants, fuite de données... La question n’est plus de savoir si elles seront impactées, mais quand. Pour assurer la pérennité de l’activité et développer la confiance, l’anticipation permise par les outils technologiques reste le meilleur moyen de défense.') }}
                            </P>
                        </div>

                        <h2 class="lg:text-3xl text-xl font-bold text-gray-800 lg:mx-5 mb-5 ">
                            {{ __('Développer sa résilience') }}
                        </h2>

                        <div class=" mt-15">

                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide lg:mx-8 text-xl">
                                {{ __('Panne matérielle, faute technique ou humaine, surcharge d’activité ou piratage informatique : des sources de risque variées peuvent entraîner une paralysie voire une suspension de l’activité. Adopter une infrastructure agile qui place la résilience au cœur de son modèle est essentiel à la sécurité et au bon fonctionnement de l’entreprise.') }}
                            </P>
                        </div>
                    ...
                    <div class="lg:flex lg:mx-12 mx-6  justify-between ">
                        <div class=" ">
                            ...
                            <p class=" text-sm  lg:text-lg   mt-4 text-gray-600">
                                {{ __('Prospérer à l’ère de la réinvention continue') }}
                            </p>
            ...
            <div class=" ">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mr-8 mx-6 lg:mx-0 lg:ml-8">
                    <div class=" mt-5 ">
                        ...
                        <button
                            class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                            <span class="font-bold text-xl">{{ __('Culture et responsabilité d’entreprise') }}</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            </svg>
                    ...
                    <div class="">
                        <div class=" lg:mt-5">
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span
                                    class="font-bold text-xl ">{{ __('Transparence et maîtrise des risques') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                            ...
                            <button
                                class="flex items-center justify-between bg-transparent h-12 text-black hover:bg-red-600 hover:text-white w-full px-4 border border-gray-400 mb-2">
                                <span class="font-bold text-xl">{{ __('Transformation des business models') }}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m8.25 4.5 7.5 7.5-7.5 7.5" />
