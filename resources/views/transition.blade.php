    ...
    <main>
        ...
        <section class=" bg-[url('/images/blog-1.jpg')]  lg:bg-cover mt-16" w-800>
            ...
            <div class="tc  w-full   ">
                ...
                <div class="  lg:ml-6  mt-72 lg:mr-6 lg:px-20 lg:w2/3">
                    <h1
                        class="lg:text-5xl text-3xl font-serif text-left ml-9 mr-14 lg:mt-20 text-white inline-block bg-gray-800 px-4">
                        {{ __('Transition écologique et sociétale') }}
                    </h1>
                    <h1 class="text-2xl font-serif lg:text-left ml-9  text-white bg-gray-800 lg:mr-64 px-4">
                        {{ __('Enrichir votre stratégie pour répondre aux enjeux écologiques et sociétaux') }}
                    </h1>
            ...
            <div class="w-full bg-red-600 text-white px-auto mx-auto">
                <div class="grid gap-6 mb-6 md:grid-cols-3 mx-auto">
                    <div class="inline-block mt-5 ml-8">
                        ...
                        <h1 class="text-4xl"> 83 %</h1>
                        <p class="my-2">
                            {{ __('des consommateurs pensent que les entreprises devraient intégrer les bonnes pratiques ESG') }}
                        </p>

                        <p class="text-sm my-5"> {{ __('Source : Etude NKCCG 2021 - ESG insights') }}</p>
                    </div>

                    <div class="inline-block mt-5 mx-4">
                        <div class="border-t-2 border-white w-[3.5rem] h-[1rem]"></div>
                        <h1 class="text-4xl"> 89 %</h1>
                        <p class="my-2">
                            {{ __('des investisseurs affirment que leur entreprise devient plus attentive aux risques ESG') }}
                        </p>

                        <p class="text-sm my-5"> {{ __('Source : Report Edelman 2019 - Trust barometer') }}</p>
                    </div>
                    ...
                    <div class="inline-block mt-5 mx-4">
                        ...
                        <p class="my-2">
                            {{ __('des investisseurs institutionnels estiment que l’ESG deviendra un standard de l’industrie') }}
                        </p>

                        <p class="text-sm my-5">{{ __('Source : Etude Natixis 2021 - ESG Investor Insight Report') }}
                        </p>
                    </div>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            <p class=" text-gray-800 py-5">
                {{ __('Désormais, tout le monde est concerné par la transition écologique et sociétale. Repenser nos modes de consommation, nos façons de travailler, d’investir et de décider implique de redéfinir la performance des entreprises et de revisiter leur raison d’être.":') }}
            </p>

            <p class=" text-gray-800 py-5">
                {{ __('Au-delà d’une actualité réglementaire qui s’accélère, on observe une prise de conscience des consommateurs, des salariés et des investisseurs qui ont besoin d’être rassurés et qui sont de plus en plus regardants sur les critères environnementaux, sociaux et de gouvernance (ESG).') }}
            </p>

            <p class=" text-gray-800 py-5" mb-5>
                {{ __('Les entreprises qui maîtrisent les dimensions ESG de leur activité sont aussi celles qui résistent le mieux aux crises. C’est dès maintenant qu’il faut prendre en compte les enjeux ESG dans les décisions.') }}
            </p>
        </section>
        <section class="">
            ...
            <div class=" bg-gray-200 ">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12 mx-6">
                    <div class="mr-6 mt-5 ">
                        <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-5 mb-10 ">
                            {{ __('Intégrer les questions de RSE dans sa stratégie de transformation') }}</h2>
                        <div class="lg:mx-8">
                            <img class=" mb-5 " alt="" w- style="background-color: transparent;"
                                src="/images/hero-pensions-support-index-2021.webp">
                        </div>
                    ...
                    <div class="">
                        <div class=" lg:mt-20">
                            <h3 class="text-2xl font-bold text-gray-800 mb-5 lg:mx-7">
                                {{ __('Stratégie et nouveaux business models') }}</h3>

                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 ">
                                {{ __('Les entreprises qui intègrent fortement la RSE dans leurs stratégies et leurs opérations sont plus susceptibles de gagner le soutien de leurs parties prenantes. Cette démarche peut également constituer le catalyseur de l’innovation et du développement de nouveaux produits, ainsi qu’un puissant levier de recrutement pour une nouvelle génération d’employés dont les valeurs correspondent à ces objectifs. Pour de nombreuses entreprises, intégrer la RSE est déterminant pour leur capacité à opérer comme pour leur acceptation par la société.') }}
                            </p>
                        </div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2 lg:mx-12  mx-6">
                    <div class="mr-6 mt-5 ">
                        <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-5 mb-5 ">
                            {{ __('Instaurer la confiance à travers une communication transparente') }}</h2>

                        <div class=" lg:mt-20">

                            <h3 class="text-2xl font-bold text-gray-800 mb-5 lg:mx-7">
                                {{ __('Pilotage et communication') }}</h3>

                            <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 ">
                                {{ __('La performance financière seule ne suffit plus à piloter une entreprise ni à apprécier sa valeur. Pour donner une vision globale de sa performance, l’entreprise doit maintenant considérer des thématiques plus larges et plus prospectives. La prise en compte des impacts environnementaux et sociaux fait partie des grandes évolutions et conduit à parler de performance globale.') }}
                            </p>
                            <P class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 ">
                                {{ __('Par ailleurs, les attentes du législateur et les besoins de transparence de l’investisseur, du citoyen, du collaborateur et du consommateur sur les engagements ESG de l’entreprise deviennent chaque jour plus prégnants.') }}
                            </P>
                        </div>
                    </div>
                    <div class="">
