...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
  ...
  <main>
    {{--  <section class=" bg-[url('/images/employees.jpg')]  lg:bg-cover mt-16  ">
        <!-- Bg Shape -->
        <div class="tc  w-full   ">

            <div class="mb-4  lg:ml-6 mx-4 lg:mt-64 mt-24 lg:mr-6 lg:px-20 lg:h-96">
                <h1
                    class="lg:text-4xl text-xl font-serif lg:text-left lg:ml-9 lg:mt-32 mr-9 lg:mr-0 text-white bg-black px-4">
                ...
                <a href="/contact"
                    ...
                    <span class="ml-9"> {{ __('En savoir plus') }}</span> <svg
    ...
    <section>
            ...
            >
                ...
                <div >
                    <h1 class="lg:text-4xl text-sm lg:mt-16 text-blue-500">{{ __('ENJEUX') }}</h1>
                    <a href="#"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Mécanisation et dynamisation de l’agriculture en Afrique') }}
                    </a>
                    <a href="#"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Automatisation et dynamisation de l’élevage') }}
                    </a>
                    <a href="/transformation"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('transformation') ? 'text-blue-700' : '' }}">
                        {{ __('Transformation des business models') }}
                    </a>
                    <a href="/transparence"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('transparence') ? 'text-blue-700' : '' }}">
                        {{ __('Transparence et maîtrise des risques') }}
                    </a>
                </div>
                ...
                <div class="lg:ml-24">
                    <h1 class="lg:text-2xl lg:mt-24"></h1>
                    <a href="/technologie"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('technologie') ? 'text-blue-700' : '' }}">
                        {{ __('Technologie et performance') }}
                    </a>
                    <a href="/transition"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('transition') ? 'text-blue-700' : '' }}">
                        {{ __('Transition écologique et sociétale') }}
                    </a>
                    <a href="#"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('#') ? 'text-blue-700' : '' }}">
                        {{ __('Responsabilité Sociétale des Entreprises') }}
                    </a>
                </div>
                ...
                <div class="lg:ml-24">
                    <h1 class="lg:text-2xl lg:mt-24"></h1>
                    <a href="/croissance"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('croissance') ? 'text-blue-700' : '' }}">
                        {{ __('Croissance des ETI') }}
                    </a>
                    <a href="/startups"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('startups') ? 'text-blue-700' : '' }}">
                        {{ __('Startups et innovation') }}
                    </a>
                    <a href="/creation"
                        class="block lg:text-xl text-sm lg:mt-4 text-gray-900 hover:bg-orange-500 hover:px-2 border-b-4 border-transparent {{ request()->is('creation') ? 'text-blue-700' : '' }}">
