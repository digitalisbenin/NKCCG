            ...
            <div class="vd  sd  qo f ho oo wf yf " :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
                <nav>
                    ...
                    <li><a href="/solutions"
                        ...
                        <li><a href="/formation"
                                class="xl text-black hover:text-blue-600 inline-block border-b-4 border-transparent hover:border-blue-600  {{ request()->is('contact') ? 'text-blue-700' : '' }}">{{ __('FORMATIONS') }}
    ...
    <main>
        ...
        <section class="  justify-start">
            ...
            <div class=" mb-6  shadow-solid-13 bg-gray-200 dark:bg-blacksection dark:border-strokedark ">
                <h2 class="fk vj zp   pr text-xl kk wm qb ml-4  lg:ml-32 "> {{ __('A la une') }}
                </h2>
                <div class="lg:w-full mx-6 lg:mx-0">
                    <div class="">
                        <div class="lg:flex  justify-between ">
                            <div class="lg:mr-6 ">
                                ...
                                <p class=" text-sm  lg:text-2xl text-black font-bold mt-6 ml-2 lg:ml-0">
                                    {{ __('Le gong de la reprise a sonné. Etes-vous prêts ?') }}


                                </p>
                                <p class=" text-sm text-center lg:text-lg ml-2 lg:ml-0  mt-4 text-gray-600">
                                    {{ __('Résultats de l\'étude Global à l\' Industrie en 2024') }}
                                </p>
                            ...
                            <div class="">
                                ...
                                <p class=" text-sm  text-center lg:text-2xl text-black font-bold mt-6">
                                    {{ __('2024 : l’économie béninoise à la recherche de facteurs de réassurance') }}


                                </p>
                                <p class=" text-sm text-center lg:text-lg  mt-4 text-gray-600">
                                    {{ __('Décryptage économique #10 - Janvier 2024') }}
                                </p>
        ...
        <section class="text-center">
            <!-- Bg Shape -->
            <div class="w-full">
                <img src="images/fr-france-paris-2024-200-logos.jpg">
                <a href="/#"
            ...
            <div class="lg:flex   lg:h-80 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-black ml-9 mt-6 lg:mr-24">
                        {{ __('A travers des événements et des webcasts réguliers, décryptons ensemble actualité aujourdhui et les tendances de demain.') }}
                    </p>
                    <a href="/#"
                        class="flex  gi lg:mt-9 mt-4 ml-9 w-44 text-black border border-black hover:bg-blue-700 block">
                        <span class="ml-9">{{ __('Je décrouvre') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-black ml-9 mt-6 lg:mr-24">
                        {{ __('Essentiel des actualité au Bénin.') }}
                    </p>
                    <a href="/#"
                        class="flex  gi lg:mt-9 mt-4 ml-9 w-44 text-black border border-black hover:bg-blue-700 block">
                        <span class="ml-9"> {{ __('Je informe') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mt-1">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                        </svg>
            ...
            <div class="flex h-44 lg:mx-64 ">
                ...
                <div class="">
                    ...
                    <p class="text-white ml-4 mt-6 ">
                        {{ __('Un besoin ? Une demande ?') }}
                    </p>
                    <a href="/contact" class="flex  gi lg:mt-4 lg:ml-4  text-white text-3xl   block">
                        <span class=""> {{ __('Contactez-nous') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <section class="">
            <div class="lg:mx-64 mx-6">
                <h1 class="text-4xl font-serif text-left  mt-9 text-black">
                    {{ __('Alerte à la fraude') }}</ </h1>
                    <p class="text-black text-xl mt-6 lg:mr-24">
                        {{ __('Nous attirons votre attention sur une pratique actuelle de personnes usurpant l’identité de professionnels des grands cabinets d’audit technique et de conseil (dont NKCCG) auprès de leurs clients ou de tiers afin d’obtenir auprès d’eux des informations sensibles (« Phishing ») ou le paiement de fausses factures (« Escroquerie »).') }}
                    </p>
                    <a href="/#"
                        class="flex  gi lg:mt-9 text-xl  w-48 text-black border border-black hover:bg-blue-700 block">
                        <span class="ml-9">{{ __('En savoir plus') }}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mt-1">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
