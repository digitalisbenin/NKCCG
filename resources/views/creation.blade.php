...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'b eh': darkMode === true }">
    ...
    <main>
        ...
        <section class=" bg-[url('/images/blog-1.jpg')]  lg:bg-cover mt-16" w-800>
            <div class="bg-white">
                <p class="text-base mx-5 text-black">
            ...
            <div class="tc  w-full   ">
                ...
                <div class="  lg:ml-6 mt-24 lg:mt-72 lg:mr-6 lg:px-20 lg:w-2/3">
                    <h1
                        ...
                        {{ __('Création et préservation de valeur') }}
                    </h1>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-3 mx-auto">
                    <div class="inline-block mt-5 ml-8">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des cessions créatrices de valeur reposent sur une stratégie de sortie formalisée') }}
                        </p>
                        <p class="text-sm my-5"> {{ __('Source : Etude Value Creation in Deals 2019') }}</p>
                    ...
                    <div class="inline-block mt-5 lg:mx-4 ml-8 lg:ml-0">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des acquéreurs passent en revue leur portefeuille d’activités avant une opération de M&A') }}
                        </p>

                        <p class="text-sm my-5">{{ __('Source : Creating value Beyond the Deal in PE 2019') }}</p>
                    </div>
                    ...
                    <div class="inline-block mt-5 lg:mx-4 ml-8 lg:ml-0">
                        ...
                        <p class="my-2 text-xl">
                            {{ __('des acquisitions ayant perdu de la valeur ont souffert d’une fuite des talents post-acquisition') }}
                        </p>
        ...
        <section class="lg:w-1/2 lg:mx-8 mx-6">
            ...
            <div>
                ...
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                    {{ __('Qu’il s’agisse d’une cession d’activité en vue d’un recentrage, d’une fusion ou d’une acquisition, les transactions figurent au cœur de l’agenda stratégique des dirigeants. Elles sont de puissants leviers de transformation si l’entreprise s’avère capable d’anticiper sa planification et de mettre en œuvre l’opération en cohérence avec sa stratégie.') }}
                </p>
                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl mb-5">
                    {{ __('L’enjeu est de réconcilier business et sens de l’action, ce qui implique de redéfinir la notion de performance. Les entreprises s’affirment aujourd’hui comme des acteurs contribuant plus largement à l’intérêt général, et la question de leur acceptabilité sociale devient un vrai sujet.') }}
                    </ </p>
        ...
        <section class=" lg:py-10">
            ...
            <div class=" bg-gray-100  lg:py-10">
                ...
                <h2 class="lg:text-4xl text-2xl text-gray-800 lg:mx-8 py-1 mx-6 lg:px-10 mb-5  ">
                    {{ __('Assurer sa transformation en conciliant business et sens de l’action') }}
                </h2>
                        ...
                        <div class="">
                            ...
                            <div class=" mt-1">
                                ...
                                <p class="text-gray-800 leading-relaxed  tracking-wide lg:mx-8 text-xl">
                                    {{ __('Identifier la transaction créatrice de valeurs Croissance externe, optimisation du portefeuille d’activités ou accès aux marchés de capitaux sont autant de moyens d’acquérir des savoir-faire innovants, de réaliser des investissements inédits, d’explorer de nouveaux territoires économiques ou géographiques. Il s’agit de détecter les transactions qui seront réellement créatrices de valeur, et ce, dans un environnement complexe et concurrentiel, désormais menacé par l’émergence de modèles économiques disruptifs.') }}
                                </p>
        ...
        <section class="">
            ...
            <div class=" ">
                ...
                <h1
                    ...
                    {{ __('Anticiper pour instaurer la confiance') }}
                </h1>
                    ...
                    <div class="lg:mr-6 lg:mt-5 ">
                        ...
                        <div class=" lg:mt-15">
                            ...
                            <P class="text-gray-800 mb-5 leading-relaxed  tracking-wide lg:mx-8 text-xl">
                                {{ __('Préparer un avenir pérenne et responsable Les acteurs qui réussissent leurs transactions sont ceux qui voient au-delà de la complexité immédiate de l’opération. Ils recherchent les signaux avant-coureurs permettant d’anticiper et de prendre les bonnes décisions pour l’avenir. Chaque transaction est envisagée, non pas comme une opération ponctuelle et isolée, mais comme une occasion inédite de se transformer en profondeur. Un pas de plus vers l’excellence stratégique et opérationnelle, vers de nouveaux usages ou vers de nouveaux marchés.') }}
                            </P>
                        </div>
