            ...
            <div class="tc  w-full   ">
                ...
                <div class=" lg:mt-52 lg:mr-6 mt-24 lg:px-20 lg:w-2/3 bg-gray-800">
                    ...
                    <p class="text-2xl font-serif text-left ml-9 mt-4 text-white">
                        ...
                        {{ __('Fibre, réseaux hertziens, satellites… Le secteur des télécoms poursuit sa mutation à mesure que la transformation digitale bouleverse besoins et usages.') }}
                    </p>
            ...
            <div class="lg:flex   lg:h-54 lg:mx-24">
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('d’abonnements Internet à haut et très haut débit sur réseaux fixes') }}
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('de croissance annuelle des abonnements très haut débit') }}
                    </p>
                    <p class="text-white ml-9 mt-9 mr-24">
                        Source : ARCEP
                    </p>
                ...
                <div class="lg:w-1/3 ">
                    ...
                    <p class="text-white ml-9 mt-6 ">
                        ...
                        {{ __('payés annuellement par SFR pour la diffusion des Ligues européennes de football (2018-2021)') }}
            ...
            <div class="lg:mx-24 lg:flex mx-6">
                <div class="lg:w-1/2 lg:mr-4">
                    <p class="text-black text-xl  ">
                        ...
                        {{ __('Transformation digitale, nouveaux entrants : le secteur des télécoms est en pleine mutation.') }}
        ...
        <section class=" ">
            ...
            <div class=" lg:mx-24 mx-6">
                ...
                <h1 class="text-4xl font-serif text-left  text-black">
                    ...
                    {{ __('Télécommunications : la grande transformation') }}
                </h1>
                ...
                <p class="text-black  mt-4 lg:w-2/4 text-lg">
                    ...
                    {{ __('Pour aller plus loin dans cette transformation, les acteurs du secteur des télécoms doivent maintenant mieux exploiter les données des utilisateurs. Un opérateur de téléphonie mobile génère plusieurs téraoctets de données par jour. Cette manne, bien interprétée, ouvre des opportunités de réduction de coûts, de développement de nouvelles offres ou encore d’amélioration de l’expérience client.') }}
                </p>
                <p class="text-black  mt-4 lg:w-2/4 text-lg">

                    {{ __('L’exploitation des données doit se faire en conformité avec la réglementation GDPR (General Data Protection Regulation).') }}
                </p>
                <h1 class="text-2xl font-bold text-left mt-4 lg:w-2/4 text-black">
            ...
            <div class=" lg:h-44 lg:mx-24 mx-6 ">
                <div class="">
                    ...
                    <h1 class="text-2xl font-bold text-left text-white mt-2">
                        ...
                        {{ __('Comment les entreprises peuvent tirer partie de la 5G ?') }}
                    </h1>
